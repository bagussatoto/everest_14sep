...
class MdlGudang extends MdlMother
{
    ...
    protected $fields = array(
        ...
        "kategori_gudang" => array(
            "label" => "kategori gudang",
            "type" => "int",
            "length" => "24",
            "kolom" => "kategori_gudang_id",
            "inputType" => "combo",
            "reference" => "MdlGudangKategori",
            //--"inputName" => "nama",
        ),
        "cabang" => array(
            "label" => "branch",
    ...
    protected $listedFields = array(
        "nama" => "name",
        "cabang_id" => "branch",
        "kategori_gudang_id" => "kategori gudang",
    ...
    public function paramSyncNamaNama()
    {
        $mdls = array(
            ...
            "MdlGudangKategori" => array(
                "id" => "kategori_gudang_id",
                "kolomDatas" => array(
                    "nama" => "kategori_gudang_nama",
                ),
            ),
            "MdlSupplier" => array(
                "id" => "supplier_id",
