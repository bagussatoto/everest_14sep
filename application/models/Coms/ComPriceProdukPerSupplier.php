...
class ComPriceProdukPerSupplier extends MdlMother
{

    protected $filters = array();
    protected $tableName;
    protected $tableName_fifoAvg;
    ...
    public function pair($inParams)
    {
        ...
        if (sizeof($this->inParams) > 0) {
            ...
            foreach ($this->inParams as $array_params) {
                ...
                $_preValues = $this->cekPreValue($array_params['static']['jenis'], $array_params['static']['jenis_value'], $array_params['static']['suppliers_id'], $array_params['static']['produk_id']);
arrPrint($_preValues);
    ...
    private function cekPreValue($jenis, $jenis_value, $suppliers_id, $produk_id)
    {
        $this->load->model("Mdls/MdlHargaProdukPerSupplier");
        $l = new MdlHargaProdukPerSupplier();
