...
//                            "supplierID" => "pihakID",
    ...
    "1687" => array(
        ...
        "valueGates" => array(//==sumber nilai yang dikirim kemana2
            "master" => array(//==sumber nilai utama
                "gudang2ID" => "pihakID",// gudang tujuan
                "gudang2Name" => "pihakName",
            ),
            "detail" => array(//===sumber nilai berupa rincian
        ...
        "tableIn" => array(
            "master" => array(
                ...
                "gudang_id" => "gudang_asal__id",
                "gudang_nama" => "gudang_asal__label",
                "gudang2_id" => "gudang",
                "gudang2_nama" => "gudang__label",
            ),
            "detail" => array(
                "dtime" => "dtime",
                "produk_id" => "id",
    ...
    "2687" => array(
        ...
        "valueGates" => array(//==sumber nilai yang dikirim kemana2
            "master" => array(//==sumber nilai utama
                "gudang2ID" => "pihakID",
                "gudang2Name" => "pihakName",
                "gudang_asal" => "warehouseSource",
                "gudang_asal__id" => "warehouseSource",
                "gudang_asal__label" => "warehouseSource__label",
                "gudang_asal__nama" => "warehouseSource__label",
                "gudang_asal__name" => "warehouseSource__label",
                "gudang" => "warehouseTarget",
                "gudang__id" => "warehouseTarget",
                "gudang__label" => "warehouseTarget__label",
                "gudang__nama" => "warehouseTarget__label",
                "gudang__name" => "warehouseTarget__label",
            ),
            "detail" => array(//===sumber nilai berupa rincian
