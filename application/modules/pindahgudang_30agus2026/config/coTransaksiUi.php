...
//            "gudang_id=gudangID",
        ...
        "receiptElements" => array(
            "gudang_asal" => array(// otomatis ke gudang project dc/pusat
...
//                "actionLabel" => "approve request",
        ...
        "template" => "template/transaksi_2.html",
...
//            "jumlah>.0",
        ...
        "selectorFilters" => array(
            ...
            "stock_locker.jumlah>.0",
            "stock_locker.state=.active",
            "stock_locker.gudang_id=pihakMainID",
        ),
        "selectorCaller" => "_selectorItem/selectItem",// bikin shopping cart background
        "selectorLabel" => "item",
        "selectorParamFields" => array(
        ...
        "pihakModel" => "MdlGudang",
        "pihakCaller" => "_selectorPihak/selectPihak",
        "pihakLabel" => "gudang tujuan pemindahan",
        "pihakLabelNote" => "Pilih Gudang Tujuan: ",
        "pihakFilters" => array(
            "cabang_id=cabang_id",
            "id<>gudang_id",
            "jenis=.gudang project",
        ...
        "pihakModelMain" => "MdlGudang",
        "pihakMainCaller" => "_selectorPihakMain/selectPihak",
        "pihakMainLabel" => "pilih gudang asal",
        "pihakMainLabelNote" => "Pilih Gudang Asal: ",
        "pihakMainFilters" => array(
            "cabang_id=placeID",
//            "id<>gudang_id",
            "kategori_gudang_id=.2",
        ),
...
//        ),
        ...
        "shoppingCartInfo" => array(
            "label_info" => "Anda melakukan pindah stok dari gudang <strong>gudang_asal__label</strong> ke gudang <strong> gudang2Name </strong>.",
            "replacer" => array(
                "gudangName",
                "gudang_asal__label",
                "gudang2Name",
...
//                    "jenis=.gudang project",
            ...
            "gudang" => array(// otomatis ke gudang project dc/pusat
                "elementType" => "dataModel",
                "inputType" => "radio",
                "label" => "gudang tujuan",
                "mdlName" => "MdlGudang",
        ...
        "receiptDetailFieldsByGudang" => array(
            2 => array(
                ...
                "filter" => array(
                    "tipe_gudang_id=.2",
                    "kategori_gudang_id=.1",
                    "supplier_id=pihakID",
                ),
                "exception" => array(
                    "key" => "gudang_asal__id",//jika > 0 maka auto gudang dc/pusat
                    "auto" => array(
                        "gudang_asal" => "-1",
                        "gudang_asal__id" => "-1",
                        "gudang_asal__label" => "Gudang Reguler DC/PUSAT",
                        "gudang_asal__nama" => "Gudang Reguler DC/PUSAT",
                        "gudang_asal__name" => "Gudang Reguler DC/PUSAT",
                    ),
...
//            "jenis=.gudang project",
        ...
        "pihakLabelNote" => "Pilih Gudang Asal:",
        "pihakAddStaticEntry" => array(
            "id" => "gudang_id",
            "label" => "gudang_nama",
        ),
...
//            "gudang_nama" => "gudang asal",
//            "gudang2_nama" => "gudang tujuan",
            "gudang_asal__nama" => "gudang asal",
            "gudang_nama" => "gudang tujuan",
            "oleh_nama" => "pic",
        ),
        //untuk penampil item di index followup tanpa klik dan hover
        "shortItemsFields" => array(
        ...
        "shoppingCartInfo" => array(
            "label_info" => "Anda melakukan pindah stok dari gudang <strong>gudang_asal__label</strong> ke gudang <strong> gudangName </strong>.",
            "replacer" => array(
                "gudangName",
                "gudang_asal__label",
                "gudang2Name",
            ...
            2 => array(
                ...
                "exception" => array(
                    ...
                    "auto" => array(
                        "gudang_asal" => "9",
                        "gudang_asal__id" => "9",
                        "gudang_asal__label" => "Gudang Project DC/PUSAT",
                        "gudang_asal__nama" => "Gudang Project DC/PUSAT",
                        "gudang_asal__name" => "Gudang Project DC/PUSAT",
                    ),
//                    "label" => "Pembelian ini adalah Dropship. Anda tidak perlu pilih gudang.",
//                    "disabled" => true,
                ),
...
//                "new_order" => "kekurangan",
            ...
            "produk_id_attr" => array(
                ...
                "nama" => array(
                    ...
                    "format_key" => "nama",
                    "link" => "_processSelectProduct/select/2587",
                    "link_modal" => false,
                ),
                "satuan" => array(),
//                "stock" => array(
