...
class ActivityReport extends Modul_Controller
{
    ...
    public function viewMonthly()
    {
        ...
        $data = array(
            ...
            "thisPage" => MODUL_PATH . get_class($this) . "/" . $this->uri->segment(2) . "/". $this->uri->segment(3) ."/". $this->jenisTr,
            "subPage" =>MODUL_PATH . $this->uri->segment(2) .  "/viewDaily/" . $this->jenisTr,
            "historyPage" => MODUL_PATH . "Transaksi/viewHistory/" . $this->jenisTr . "/$stID" . "?stID=" . $stID,
            "stepNames" => $stepNames,
