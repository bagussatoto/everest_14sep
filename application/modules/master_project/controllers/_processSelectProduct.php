...
class _processSelectProduct extends Modul_Controller
{
    ...
    public function select()
    {
        ...
        matiHEre("hoop" . __LINE__ . " FILE " . __FILE__);
    ...
    public function items2()
    {
        ...
        $selectorSrcModel = isset($this->configUi[$this->jenisTr]['selectorSrcModel2']) ? $this->configUi[$this->jenisTr]['selectorSrcModel2'] : matiHEre(" undefine model!");
            ...
            foreach ($tmpB as $row) {
                ...
                if (!array_key_exists($id, $_SESSION[$cCode]['items2_sum'])) {
                    ...
                    if (sizeof($itemNumLabels) > 0) {
                        ...
                        if (sizeof($_SESSION[$cCode]['items2_sum'][$id][$key]) > 0) {
                            if (!isset($_SESSION[$cCode]["items2_sum"][$id]['nilai_untung'])) {
                                $_SESSION[$cCode]["items2_sum"][$id]['nilai_untung'] = 0;
                            }
                            if (!isset($_SESSION[$cCode]["items2_sum"][$id]['nilai_rugi'])) {
                                $_SESSION[$cCode]["items2_sum"][$id]['nilai_rugi'] = 0;
                            }
                            $_SESSION[$cCode]["items2_sum"][$id]['nilai_untung'] = ($_SESSION[$cCode]["items2_sum"][$id]['harga'] - $_SESSION[$cCode]["items2_sum"][$id]['harga_sisa']) >= 0 ? ($_SESSION[$cCode]["items2_sum"][$id]['harga'] - $_SESSION[$cCode]["items2_sum"][$id]['harga_sisa']) : 0;
                            $_SESSION[$cCode]["items2_sum"][$id]['nilai_rugi'] = ($_SESSION[$cCode]["items2_sum"][$id]['harga'] - $_SESSION[$cCode]["items2_sum"][$id]['harga_sisa']) >= 0 ? 0 : ($_SESSION[$cCode]["items2_sum"][$id]['harga_sisa'] - $_SESSION[$cCode]["items2_sum"][$id]['harga']);
