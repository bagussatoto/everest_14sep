...
class MdlProjectKomposisi extends MdlMother
{
    protected $tableName = "project_komposisi";
    protected $tableName2 = "project_produk";
    ...
    protected $listedFieldsSelectItem = array(//===kolom2 yang dibaca saat searching. silahkan di-override di model masing2 jika kolomnya kurang
        "nama" => "projedct_produk.nama",
    );
    protected $search;
    protected $filters = array(
//        "jenis='produk'",
        "jenis in ('produk','item_komposit')",
        "project_komposisi.status='1'",
        "project_komposisi.trash='0'",
    );
    ...
    protected $listedFields = array(
        ...
        "produk_dasar_nama" => "material",
        "kode" => "kode",
        "satuan_nama"          => "satuan",
        "jml"          => "jml",
        "nilai"        => "HPP Realisasi",
        "harga_budget" => "Harga Budget",
        "harga"        => "Harga Jual",
        "allow_autopurchase" => "autopurchase",
    );
