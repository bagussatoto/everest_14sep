...
class MdlProjectKomposisiWorkorderSub extends MdlMother
{
    protected $tableName = "project_komposisi_sub_workoder";
    ...
    protected $filters = array(
        ...
        "project_komposisi_sub_workoder.status='1'",
        "project_komposisi_sub_workoder.trash='0'",
    );
