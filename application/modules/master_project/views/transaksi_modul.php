...
$('#uplodXls').on('submit',function() {
    ...
    case "editPreview":
        ...
        if (isset($items) && sizeof($items) > 0) {
            ...
            echo "<div class='col-md-6'>";
            echo "<button type='button' class='btn btn-block btn-success' onclick=\"if(confirm('your selected items will be processed. Continue saving?')==1){document.getElementById('result').src='" . $actionTarget . "';$(this).prop('disabled', true);top.open_holdon();}\"><span class='glyphicon glyphicon-ok'></span> $buttonLabel</button>";
            echo "</div class='col-md-6'>";
                ...
                $paymentRows = array(
                    ...
                    "" => "<input type=button class='btn btn-success btn-block' id='btnSave' value='$btnLabel' disabled 
                        onclick=\"
                                ...
                                {if(typeof top.swal === 'function'){top.swal('Peringatan', 'Silakan isi nilai nominal dengan benar.', 'warning');}else{alert('Silakan isi nilai nominal dengan benar.');}} else {$actionTarget}\">",
                );
