                            ...
                            footerCallback: function ( row, data, start, end, display ) {
                                    ...
                                    var arrayFooter = $('#data_history_$jenisTr>tfoot>tr>th');
                                        ...
                                        jQuery.each(arrayFooter, function(i,d){
                                            ...
                                            if(pos!==-1&&hr==-1&&br==-1&&id_n_index>0){
                                                    dpageTotal[id_n_index] += intVal( $(obj).html() );
                                                }
                                                else{
...
if(strIDs.length>0){top.document.getElementById('result').src='$followupBase'+strIDs+'/$_nextStepNum/$_currentStepNum';}else{if(typeof top.swal === 'function'){top.swal('Peringatan', 'Silakan pilih setidaknya satu data transaksi.', 'warning');}else{alert('Silakan pilih setidaknya satu data transaksi.');}}
