...
//            ),
        ...
        "shoppingCartNumFields2" => array(
            1 => array(
                "jml" => "jumlah",
                "hpp_supplier" => "HPP Realisasi",
                "harga_budget" => "Harga Budget",
                "harga" => "Harga Jual Project",
                "subtotal" => "subtotal",
            ),
            2 => array(
                "jml" => "jumlah",
        ...
        "shoppingCartNumFields3" => array(
            1 => array(
                "jml" => "jumlah",
                "anggaran" => "HPP Realisasi Biaya",
                "harga_budget" => "Budget Biaya",
                "harga" => "Harga Jual Project",
                "subtotal" => "subtotal",
            ),
            2 => array(
            ...
            "dummyElement" => array(
                "yes" => array(
                    "total_anggaran" => array(
                        "label" => "Total HPP Realisasi Proyek",
                        "defaultValue" => ".0",
                        "keyupAction" => "",
                        'disabled' => "disabled",
                        "addPoints" => array(1,),
                    ...
                    "total_budget" => array(
                        "label" => "Total Budget Anggaran Proyek",
                        "defaultValue" => ".0",
                        "keyupAction" => "",
                        'disabled' => "disabled",
                        "addPoints" => array(1,),
                    ...
                    "harga_non_ppn" => array(
                        "label" => "Total Rincian Jual Barang",
                        "defaultValue" => ".0",
                        "keyupAction" => "",
                        'disabled' => "disabled",
                        "addPoints" => array(1,),
                    ...
                    "harga_jual_project" => array(
                        "label" => "Harga Kontrak Project <r>(Excl.PPN)</r>",
                        "defaultValue" => ".0",
...
//                        'disabled' => "false",
                    ...
                    "perkiraan_rl_hpp" => array(
                        "label" => "Estimasi Laba Kotor (Profit)",
                        "defaultValue" => ".0",
                        "keyupAction" => "",
                        'disabled' => "disabled",
                        "addPoints" => array(1,),
                    ...
                    "perkiraan_rl_ang" => array(
                        "label" => "Selisih Kontrak vs Rincian",
                        "defaultValue" => ".0",
                        "keyupAction" => "",
                        'disabled' => "disabled",
                        "addPoints" => array(1,),
