...
switch ($mode) {
    case "viewHistory":
        ...
        $content_all .= "<table id='table_history_$segmenUriEnc' class='table display no-padding'>";
...
// cekLime($thisPage);
    ...
    case "showData":
        ...
        $content .= "<h4 class='box-title'>Riwayat transaksi</h4> <span class='meta' style='color:#ffffff;'>$limit_view</span>";
        $content .= "<div class='box-tools pull-right'>";
//        $content .= "<span>klik disini melihat seluruh history >>> </span>";
        $content .= "<button type='button' class='btn btn-box-tool' title='melihat seluruh history' onclick=\"location.href='$link_history'\">Klik disini melihat seluruh history <i class='fa fa-list'></i></button>";
