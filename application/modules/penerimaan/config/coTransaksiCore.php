    ...
    "749__" => array(
        ...
        "valueGates" => array(//==sumber nilai yang dikirim kemana2
            ...
            "detail" => array(//===sumber nilai berupa rincian
                ...
                "netto_lebih_bayar_marketplace" => "sub_kelebihanBayarMarketplace-nilai_pengembalian_deposit",
...
//                        "nilai_cash" => "nilai_entry-lebih_bayar",
                ...
                "tipe_penjualan" => array(
                    "0" => array(// reguler
                        "deposit_konsumen" => "lebih_bayar",
                        "deposits_konsumen_marketplace" => ".0",

                    ),
                    "1" => array(// marketplace
                        "deposit_konsumen" => ".0",
                        "deposits_konsumen_marketplace" => "lebih_bayar",
...
//            "lebih_bayar" => "(nilai_dijadikan_credit_note_pph+nilai_entry+nilai_biaya+pph22_nilai+ppn_nilai_dibayar+totalCredit+point_konsumen_nilai_dipakai+pph23)-nilai_round",
            ...
            //---------------------
            "hutang_ke_konsumen_dipakai" => "uang_muka_dipakai_ppn+credit_note_dipakai+uang_muka_dipakai+point_konsumen_nilai_dipakai",
            "hutang_ke_konsumen_ditambah" => "deposits_konsumen_marketplace+deposit_konsumen",
            "nilai_setor_cash_netto" => "nilai_cash-nilai_pengembalian_deposit",
        ),
...
//                            "nilai" => "credit_note_dipakai+nilai_cash+nilai_biaya+uang_muka_dipakai+pph22_nilai+ppn_nilai_dibayar+selisih_round+point_konsumen_nilai_dipakai+pph23", // nilai pembayaran total
                            ...
                            "lebih_bayar" => "kelebihanBayarMarketplace",
                        ),
                        "resultParams" => array(
                            "main" => array(
...
//                "bank_rekening_nama" => "bank_rekening_nama",
        ...
        "components" => array(
            "749" => array(
                "master" => array(
                    // region  MENGAMBIL HUTANG KE KONSUMEN DI DC PINDAH KE CABANG=====
                    // PUSAT
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
...
//                            "extern_nama" => "pihakName",
                    ...
                    array(
                        ...
                        "loop" => array(
//                            "1010010010" => "nilai_cash+deposit_konsumen+pendapatan_lain_lain+deposits_konsumen_marketplace",// kas
                            "1010010010" => "nilai_cash",// kas
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                    ...
                    //hutang ke konsumen dibawa ke atas
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "2040010" => "(deposits_konsumen_marketplace+deposit_konsumen-nilai_pengembalian_deposit)",// hutang ke pusat
                            "2010050" => "-(deposits_konsumen_marketplace+deposit_konsumen-nilai_pengembalian_deposit)",// hutang ke konsumen
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
...
//                            "extern_nama" => "pihakName",
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "1010060010" => "deposits_konsumen_marketplace+deposit_konsumen-nilai_pengembalian_deposit",// piutang cabang
                            "2010050" => "deposits_konsumen_marketplace+deposit_konsumen-nilai_pengembalian_deposit",// hutang ke konsumen
                        ),
                        "static" => array(
                            "cabang_id" => ".-1",
                    ...
                    array(
                        "comName" => "RekeningPembantuAntarcabang",
                        "loop" => array(
                            "1010060010" => "deposits_konsumen_marketplace+deposit_konsumen-nilai_pengembalian_deposit",// hutang ke pusat
                        ),
                        "static" => array(
                            "cabang_id" => ".-1",
                            "cabang2_id" => "placeID",
                    ...
                    // region PENGEMBALIAN DEPOSIT KE KONSUMEN
                    // CABANG, KAS KELUAR, DEPOSIT KELUAR
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "1010010010" => "-nilai_pengembalian_deposit",// kas
                            "2010050" => "-nilai_pengembalian_deposit",// hutang ke konsumen
                    ...
                    // endregion PENGEMBALIAN DEPOSIT KE KONSUMEN
...
//                     rekening pembantu piutang usaha marketplace detail
                    ...
                    // hutang ke konsumen pembantu dibawa ke atas

                    // rekening pembantu hutang ke konsumen, uang muka (lebih bayar)
                    array(
                        "comName" => "RekeningPembantuCustomerItem",
                        "loop" => array(
                            "2010050" => "sub_kelebihanBayarMarketplace",// hutang ke konsumen
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => ".2010050050",
                    ...
                    // CABANG, DEPOSIT KELUAR, DIKEMBALIKAN KE KONSUMEN
                    // rekening pembantu hutang ke konsumen, uang muka (lebih bayar)
                    array(
                        "comName" => "RekeningPembantuCustomerItem",
                        "loop" => array(
                    ...
                    array(
                        "comName" => "RekeningPembantuCustomerItem",
                        "loop" => array(
//                            "2010050" => "-(sub_kelebihanBayarMarketplace-nilai_pengembalian_deposit)",// hutang ke konsumen
                            "2010050" => "-netto_lebih_bayar_marketplace",// hutang ke konsumen
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => ".2010050050",
...
//                            "oleh_id" => ".0",
                    ...
                    // LOCKER KAS DIKURANGI, PENGEMBALIAN DEPOSIT
                    array(
                        "comName" => "LockerValue",
                        "loop" => array(),
                        "static" => array(
                            ...
                            "nama" => "cash_account",
                            "nilai" => "-nilai_pengembalian_deposit", // nilai_entry
                            "transaksi_id" => ".0",
                            "oleh_id" => ".0",
                        ),
                        "srcGateName" => "main",
...
//                            "transaksi_saldo" => "grandTotal",
                    ...
                    // payment source uang muka tanpa ppn (lebih bayar marketplace) langsung dibawa kepusat tanpa identitas cabang
                    array(
                        ...
                        "static" => array(
                            ...
                            "extern_nama" => "extern_nama",
                            "label" => ".uang muka konsumen",
//                            "tambah" => "sub_kelebihanBayarMarketplace-nilai_pengembalian_deposit",
                            "tambah" => "netto_lebih_bayar_marketplace",
                            "extern_label2" => ".customer",//ini update untuk pembeda vemdor/ customer
                        ),
                        "reversable" => true,
                        "srcGateName" => "items",
                ...
                "master" => array(
                    array(
                        ...
                        "static" => array(
                            ...
                            "nilai" => "nilai_entry+nilai_dijadikan_credit_note_pph-nilai_pengembalian_deposit",
                        ),
                        "resultParams" => array(
                            "main" => array(
                                "nilai_dipakai" => "nilai_dipakai",
...
//                            "1010010010" => "-(nilai_entry-nilai_pengembalian_deposit)",// kas
                            "1010010010" => "-nilai_setor_cash_netto",// kas
                            "1010010030" => "-nilai_dijadikan_credit_note_pph",// credit note
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                ...
                "master" => array(
                    ...
                    array(
                        ...
                        "static" => array(
                            ...
                            "produk_id" => "cash_account_id",
                            "nama" => "cash_account_nama",
//                            "nilai" => "-(nilai_entry-nilai_pengembalian_deposit)",
                            "nilai" => "-nilai_setor_cash_netto",
                            "transaksi_id" => ".0",
                            "oleh_id" => ".0",
                        ),
                        "srcGateName" => "main",
...
//                            "nilai" => "(nilai_entry-nilai_pengembalian_deposit)",
                    ...
                    array(
                        ...
                        "static" => array(
                            ...
                            "target_jenis" => ".759",
                            "transaksi_id" => "transaksi_id",
//                            "terbayar" => "nilai_entry-nilai_pengembalian_deposit",
                            "terbayar" => "nilai_setor_cash_netto",
                            "sisa" => ".0",
                        ),
                        "reversable" => true,
                        "srcGateName" => "main",
        ...
        //------------------------------
//        "preProcessorDeposit" => array(),
//        "componentsDeposit" => array(
//            "749" => array(
//                "master" => array(
//                    // PUSAT, DEPOSIT KELUAR
//                    array(
//                        "comName" => "Jurnal",
//                        "loop" => array(
//                            "1010060010" => "-nilai_pengembalian_deposit",// piutang cabang
//                            "2010050" => "-nilai_pengembalian_deposit",// hutang ke konsumen
//                        ),
//                        "static" => array(
//                            "cabang_id" => ".-1",
...
//                    ),
//
//                    // CABANG, DEPOSIT MASUK
//                    array(
//                        "comName" => "Jurnal",
//                        "loop" => array(
//                            "2010050" => "nilai_pengembalian_deposit",// hutang ke konsumen
//                            "2040010" => "-nilai_pengembalian_deposit",// hutang ke pusat
//                        ),
//                        "static" => array(
//                            "cabang_id" => "placeID",
//                            "jenis" => "jenisTr",
...
//                            "extern_nama" => "extern_nama",
//                            "label" => ".uang muka konsumen",
//                            "terbayar" => "nilai_pengembalian_deposit",
//                            "extern_label2" => ".customer",//ini update untuk pembeda vemdor/ customer
//                        ),
//                        "reversable" => true,
//                        "srcGateName" => "items",
...
//            "lebih_bayar" => "(nilai_dijadikan_credit_note_pph+nilai_entry+nilai_biaya+pph22_nilai+ppn_nilai_dibayar+totalCredit+point_konsumen_nilai_dipakai+pph23)-nilai_round",
            ...
            "hutang_ke_konsumen_dipakai" => "uang_muka_dipakai_ppn+credit_note_dipakai+uang_muka_dipakai+point_konsumen_nilai_dipakai",
            "hutang_ke_konsumen_ditambah" => "deposits_konsumen_marketplace+deposit_konsumen",
            "total_deposit_konsumen" => "deposits_konsumen_marketplace+deposit_konsumen",
        ),
        "valuePopulator" => array(
            //            array(
            "valueSrc" => "nilai_bayar",
...
//                        "loop" => array(
//                            "7010150" => "pendapatan_lain_lain",// pendapatan lain_lain
//                            "2010050" => "(deposits_konsumen_marketplace+deposit_konsumen)",// hutang ke konsumen
//                            "1010010010" => "(deposits_konsumen_marketplace+deposit_konsumen+pendapatan_lain_lain)",// kas
//                        ),
//                        "static" => array(
//                            "cabang_id" => "placeID",
//                            "jenis" => "jenisTr",
...
//                            "extern_nama" => "pihakName",
                    ...
                    array(
                        "comName" => "RekeningPembantuCustomer",
                        "loop" => array(
//                            "2010050" => "-uang_muka_dipakai_ppn", // JADI DPP+PPN // hutang ke konsumen //uang_muka_project_dpp_dipakai
                            "2010050" => "-uang_muka_project_dpp_dipakai", // hutang ke konsumen //uang_muka_project_dpp_dipakai karena ppn sudah lunas saat terima uang muka dari konsumen
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => ".2010050060",
...
//                            "2010050" => "-uang_muka_dipakai_ppn",// JADI DPP+PPN  hutang ke konsumen //uang_muka_project_dpp_dipakai
                    ...
                    // uangmuka konsumen - projectid// khusus konsumen project
                    array(
                        "comName" => "RekeningPembantuCustomerProject",
                        "loop" => array(
                            "2010050" => "-uang_muka_nppn_relasi_soproject",// hutang ke konsumen
//                            "2010050" => "-uang_muka_project_dpp_dipakai",// hutang ke konsumen
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => "pihakID",
                            "extern_nama" => "pihakName",
                            "extern2_id" => "projectID",// projectid
                            "extern2_nama" => "projectName",// projectnama
                            "jenis" => "jenisTr",
                            "transaksi_no" => "nomer",
                        ),
                        "srcGateName" => "main",
...
//                    ),
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
//                            "2040010" => "(deposits_konsumen_marketplace+deposit_konsumen)",// hutang ke pusat
//                            "2010050" => "-(deposits_konsumen_marketplace+deposit_konsumen)",// hutang ke konsumen
                            "2040010" => "total_deposit_konsumen",// hutang ke pusat
                            "2010050" => "-total_deposit_konsumen",// hutang ke konsumen
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
...
//                            "extern_nama" => "pihakName",
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
//                            "1010060010" => "deposits_konsumen_marketplace+deposit_konsumen",// piutang cabang
//                            "2010050" => "deposits_konsumen_marketplace+deposit_konsumen",// hutang ke konsumen
                            "1010060010" => "total_deposit_konsumen",// piutang cabang
                            "2010050" => "total_deposit_konsumen",// hutang ke konsumen
                        ),
                        "static" => array(
                            "cabang_id" => ".-1",
...
//                            "2010050" => "deposits_konsumen_marketplace+deposit_konsumen",// hutang ke konsumen
                    ...
                    array(
                        "comName" => "RekeningPembantuAntarcabang",
                        "loop" => array(
//                            "1010060010" => "deposits_konsumen_marketplace+deposit_konsumen",// hutang ke pusat
                            "1010060010" => "total_deposit_konsumen",// hutang ke pusat
                        ),
                        "static" => array(
                            "cabang_id" => ".-1",
                            "cabang2_id" => "placeID",
...
//                            "oleh_id" => ".0",
                    ...
                    array(
                        ...
                        "static" => array(
                            ...
                            "extern2_nama" => "so_num",// transaksi nomer referensi so project
                            "referensi_po_id" => "so_id",// transaksi id referensi so project
                            "terbayar" => "uang_muka_dipakai_ppn",//uang_muka_project_dpp_dipakai
                            "ppn_sisa" => "uang_muka_project_ppn_dipakai", //untuk mengurangi ppn_sisa di payment_source pernah terlewat tidak di kurangi | 31 jul 2026
                            "gateSource" => ".main",
                        ),
                        "reversable" => true,
                        "srcGateName" => "main",
...
//                            "transaksi_saldo" => "grandTotal",
                    ...
                    array(
                        ...
                        "static" => array(
                            ...
                            "extern_nama" => "extern_nama",
                            "label" => ".uang muka konsumen",
                            "tambah" => "sub_kelebihanBayarMarketplace",
                            "extern_label2" => ".customer",//ini update untuk pembeda vemdor/ customer
                        ),
                        "reversable" => true,
                        "srcGateName" => "items",
