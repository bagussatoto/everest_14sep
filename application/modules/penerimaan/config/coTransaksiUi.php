...
$config["coTransaksiUi"] = array(
    ...
    "749" => array(
        ...
        "shortHistoryFields" => array(
            ...
            "uang_muka_dipakai_ppn" => "uang muka project",
...
//                "noPrefetch" => true,
            ...
            "uangMukaProject" => array(
                "elementType" => "dataModel",
                "inputType" => "radio",
                "label" => "Uang Muka Project (DPP+PPN)",
                "mdlName" => "MdlPaymentUangMukaPpn",
                "mdlFilter" => array(
                    "extern_id=pihakID",
...
//                        "cabang_id" => ".-1",
                    ...
                    "rekening" => "2010050",
                    "fieldID" => "kredit",
                    "fieldLabel" => "saldoUangMukaProject",
                ),
//                "key" => "id",
                "key" => "extern_id",
                "labelSrc" => "sisa",
...
//                    "extern_id" => "pihakID",
//                    "extern_label2" => "tipe",
//                    "saldoUangMukaPPN" => "sisa",

                    "extern_nama" => "customer",
                    "extern_id" => "pihakID",
                    "transaksi_id" => "transaksi_id",
                    "project_nama" => "project",
                    "extern2_id" => "project nilai",
                    "sisa" => "sisa",
                    "ppn_sisa" => "ppn",
                    "jenis" => "jenis",
                ),
...
//                        ),
        ...
        "shoppingCartUnionValidators" => array(
            array(
                ...
                "nilai_dijadikan_credit_note" => "Nilai Dijadikan Creditnote Supplier",
            ),
        ),
        ...
        "shopingCartUnionComparisonException" => array(
            //lebih dari 0, maka nilai entry dikeluarkan dari validate
...
//            "diskon" => "discount",
        ...
        "shoppingCartReferenceExternFields" => array(
            "extern_id" => "ID",
            "extern_nama" => "customer",
            "qty_nota" => "total<br>invoice",
            "qty_nota_reguler" => "nota<br>reguler",
            "qty_nota_project" => "nota<br>project",
            "tenor" => "TOP",
            "limit" => "Limit",
            "tagihan" => "tagihan",
            "terbayar" => "dibayar",
...
//                        "maxValue" => "uangMuka__saldoUangMuka",
                    ...
                    "uang_muka_dipakai_ppn" => array(
                        "label" => "Uang Muka Project",
                        "defaultValue" => "0",
//                        "maxValue" => "uangMuka__saldoUangMuka",
                        "maxValue" => "uangMukaProject__saldoUangMukaRound",
                        "saldo" => "uangMukaProject__saldoPakai",
                        "info" => "",
                        'disabled' => "disabled",
                        "addPoints" => array(1,),
                    ),
...
//                "lebih_bayar",
        ...
        "kelebihanBayarMarketplace" => array(
            "enabled" => true,
            "keyLebihBayar" => "kelebihanBayarMarketplace",
            "gateSource" => "items",
            "header" => array(
                "nama" => "item name",
                "nomer_top" => "nomer inv",
                "extern_nama" => "konsumen",
                "sisa" => "sisa tagihan",
                "kelebihanBayarMarketplace" => "nilai kelebihan",
                "kelebihanBayarMetode" => "action",
            ),
            "summaryHeader" => array(
                "sisa",
                "kelebihanBayarMarketplace",
            ),
            "editableFields" => array(
                "kelebihanBayarMarketplace",
            ),
            "editableFieldsOptions" => array(
                1 => array(
                    "kelebihanBayarMetode" => array(
                        "elementType" => "dataField", //dataModel, dataField, Array, Json
                        "inputType" => "combo",
                        "label" => "status pph",
                        "validate" => array(
                            "key" => "checked",
                        ...
                        "dataField" => array(
                            1 => "Deposit Konsumen",
                            2 => "Kembali Uang ke Konsumen",
                        ),
                        "urlHandler" => MODUL_PATH . "_processSelectNota/selectLebihBayarMetode/749/",
                    ),
                ),
            ),
            "validate" => true,
            "label" => "Metode kelebihan bayar marketplace wajib dipilih. Silahkan dikoreksi lagi.",
            "autoRequestPengembalian" => array(
                "enabled" => true,
                "connectTo" => "9467",
            ),
        ),
...
//                    "skip_faktur" => "checkbox",
        ...
        "linkMenu" => array(
            1 => array(
                "link" => "Transaksi/index/74677",
                "label" => "Penerimaan dari konsumen untuk pajak",
            ),
        ),
        "linkMenuHistory" => array(
            1 => array(
                "link" => "History/viewHistory/74677",
                "label" => "History Penerimaan dari konsumen untuk pajak",
            ),
        ),
...
//                    "skip_faktur" => "checkbox",
    ...
    "74677" => array(
        ...
        "steps" => array(
            1 => array(
                "label" => "Penerimaan konsumen untuk pajak",
                "actionLabel" => "process receivement",
                "source" => "",
                "target" => "74677",
                "userGroup" => "o_finance",
...
//            ),
        ...
        "linkMenu" => array(
            1 => array(
                "link" => "Transaksi/index/749",
                "label" => "A/R Receipt",
            ),
        ),
        "linkMenuHistory" => array(
            1 => array(
                "link" => "History/viewHistory/749",
                "label" => "History A/R Receipt",
            ),
