...
//            $content .= "to go back to index, you can click BACK button<br>";
                    ...
                    $(document).ready( function(){
                        var table = $('#table_history_$segmenUriEnc').DataTable({
                            ...
                            buttons: [
                                        ...
                                        {   text: 'Tampilkan/Sembuntukan Detil Isi',
                                            action: function(e, dt, node, config) {
                                              $('table[name=tableHistoryShow]').toggleClass('hidden');
                                            }
                                        },
                                        $custom_button
                                    ],
        ...
        $contentStr .= "<div class='box-header with-border'>
                            ...
                            <span class='box-tools pull-right'>$strBg <button type='button' class='btn btn-box-tool text-red' onclick=\"btn_alert_result('$jdlBtn','membuka editor bill','$link_allow_edit');\"><i class='fa fa-legal'></i></button></span>
                        </div>";
        ...
        /* ----------------------------------------------------------------------------------------------------
         * loader untuk yg akan dieksekusi CLI
         * ----------------------------------------------------------------------------------------------------*/
        $undoneList = "<div class='col-md-12' id='undoneList' style='margin-top: 5px;'></div>";

        $undoneList_link = base_url() . "invoicing/Transaksi/viewUndoneItemsIndex/4822?gr=aW52b2ljaW5n/?ohyes=ohno";
        $undoneList .= "<script>
            $('#undoneList').load('$undoneList_link');
        </script>";
        // --------------------------------------------------------------------------------------------------------
    ...
    case "showData":
        ...
        $content .= "<div class='box-tools pull-right'>$strBg ";
        ...
        $columnsArr = array();
        $ci = 0;
        foreach ($arrayHistoryLabels as $k => $lbl) {
            $columnsArr[] = "{ data: $ci, defaultContent: '' }";
            $ci++;
        }
        $columnsJsStr = implode(",\n                                ", $columnsArr);
        ...
        $content .= "<script>
                    $(document).ready( function(){
                        ...
                        table.on('draw', function() {
                            $('.table-responsive.data_history_$jenisTr').floatingScroll('update');
