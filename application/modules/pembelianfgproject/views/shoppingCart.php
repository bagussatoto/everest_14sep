                    ...
                    switch ($listMode[$key]) {
                        case "input":
                            ...
                            if (isset($keyupAction) && $keyupAction == true) {
                                ...
                                // dimatikan karena mengover-write 0.1 milik valas
//                                echo "onkeyup=\"delay( function(){ $('#shopping_cart').trigger('change') }, 400, this );if(parseFloat(removeCommas(this.value))>0){ this.value=addCommas(this.value) }else{ this.value=0 }\"";
                        ...
                        case "text":
                            ...
                            if (isset($iSpec['project_nama']) && strlen($iSpec['project_nama']) > 0 && ($key == 'nama' || $key == 'produk_nama')) {
                                $add_data_val .= "<br><span class='label label-info' style='font-size:11px;margin-top:3px;display:inline-block;'><i class='fa fa-folder-open'></i> " . htmlspecialchars($iSpec['project_nama']) . "</span>";
                            }
...
//            echo "</div>";
        ...
        echo "<script>
                ...
                if (typeof top.loadProjectPoolInline === 'function') {
                    top.loadProjectPoolInline();
                } else if (typeof loadProjectPoolInline === 'function') {
