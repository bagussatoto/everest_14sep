...
//matiHere(__LINE__);
        if($_GET["sub_target"] == "produk"){
            ...
            foreach($mainDataMaterial as $idMaterial => $dataMaterial){
                ...
                if($dataMaterial['hpp_supplier']*1 == 0){
                    $nama_materialnya = $_SESSION[$cCode][$switchTargetGate][$idMaterial]['nama'];
                    unset($_SESSION[$cCode][$switchTargetGate][$idMaterial]);
                    $alerts = array(
                        "title" => "HPP Material Tidak Ditemukan",
                        "html"  => "Material <r>($nama_materialnya)</r> belum memiliki HPP dari pembelian project.<br><br>HPP hanya dapat bersumber dari riwayat penerimaan/pembelian pada gudang project. Silahkan pastikan material ini sudah memiliki transaksi pembelian project sebelum digunakan.",
                        "type" => "info",
                    );
                    echo swalAlert($alerts);
                    die();
                    ...
                    cekHijau($dataMaterial['hpp_supplier']);
                }
            }
        }
...
//        matiHere(__LINE__);
        ...
        $total_project = $_SESSION[$cCode]['main']['harga_jual_project']*1 > 0 ? $_SESSION[$cCode]['main']['harga_jual_project']*1.11 : 0;
        $total_project_last = $_SESSION[$cCode]['main']['harga_nppn_last']*1 > 0 ? $_SESSION[$cCode]['main']['harga_nppn_last']*1 : 0;
        $total_harga_termin = $_SESSION[$cCode]['main']['total_harga_termin']*1 > 0 ? $_SESSION[$cCode]['main']['total_harga_termin']*1 : 0;
