...
class Create extends Modul_Controller
{
    ...
    public function index()
    {
        ...
        * ---------------------------------------------------------------------*/
        $initMasterValues = heInitMasterValues_he_cart($this->jenisTr, 1, $configUi[$this->jenisTr]);
...
//                arrPrint($selectorProcessor);
        ...
        if ($connectTo != "") {
            ...
            $str_scriptBottom .= " \n top.$('#kepoinList').load('$link_kepoinList')";
        }
        //endregion
        ...
        $str_scriptBottom .= "<script>
                   top.$('#historyList').load('$link_historyList')
         </script>
        ";
        //endregion

        if (isset($_SESSION[$cCode]["main"]["pihakExternMasterID"]) && ($_SESSION[$cCode]["main"]["pihakExternMasterID"] != NULL)) {
            $str_scriptBottom .= "<script>
                   top.$('#itemKeyword').prop('disabled', false)
         </script>
        ";
        }
        ...
        $data = array(
            ...
            "str_scriptBottom" => $str_scriptBottom,

            "warning_item" => isset($this->configUi[$jenisTr]["warning_item"]) ? $this->configUi[$jenisTr]["warning_item"] : "",
        );
        //endregion
    ...
    public function preview()
    {
        ...
        //---------------------------
        $jenisTr_reference_trans = (isset($_SESSION[$cCode]["main"]["pihakExternMasterID"])) ? $_SESSION[$cCode]["main"]["pihakExternMasterID"] : $this->jenisTr;
        $configUiMasterModulJenis = loadConfigModulJenis_he_misc($jenisTr_reference_trans, "coTransaksiUi");
        $configCoreMasterModulJenis = loadConfigModulJenis_he_misc($jenisTr_reference_trans, "coTransaksiCore");
        $configLayoutMasterModulJenis = loadConfigModulJenis_he_misc($jenisTr_reference_trans, "coTransaksiLayout");
        cekHere(":: $jenisTr_reference_trans ::");
//        arrPrintKuning($configUiMasterModulJenis);
        ...
        $itemLabels = isset($configUiMasterModulJenis['shoppingCartFields'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartFields'][$stepNumber] : array();
        $itemLabels2 = isset($configUiMasterModulJenis['shoppingCartFields2'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartFields2'][$stepNumber] : array();
        $itemLabels3 = isset($configUiMasterModulJenis['shoppingCartFields3'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartFields3'][$stepNumber] : array();
        $itemSrcLabels = isset($configUiMasterModulJenis['shoppingCartFieldItemSrc'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartFieldItemSrc'][$stepNumber] : array();
        $itemNumLabels = isset($configUiMasterModulJenis['shoppingCartNumFields'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartNumFields'][$stepNumber] : array();
        $itemNumLabels2 = isset($configUiMasterModulJenis['shoppingCartNumFields2'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartNumFields2'][$stepNumber] : array();
        $itemNumLabels3 = isset($configUiMasterModulJenis['shoppingCartNumFields3'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartNumFields3'][$stepNumber] : array();
        $itemSrcNumLabels = isset($configUiMasterModulJenis['shoppingCartNumFieldItemSrc'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartNumFieldItemSrc'][$stepNumber] : array();
        $fieldSrcs = isset($this->configUi[$this->jenisTr]['shoppingCartFieldSrc']) ? $this->configUi[$this->jenisTr]['shoppingCartFieldSrc'] : array();
        $fieldSrcsPym = isset($configUiMasterModulJenis['shoppingCartFieldSrcPym']) ? $configUiMasterModulJenis['shoppingCartFieldSrcPym'] : array();
        $appletConfigs = isset($configUiMasterModulJenis['applets']) ? $configUiMasterModulJenis['applets'] : array();
        ...
        if (sizeof($elementConfigsOrig) > 0) {
            ...
            foreach ($elementConfigsOrig as $xx => $xxSpec) {
                $configUiMasterModulJenis['receiptElements'][$xx] = $xxSpec;
            }
        }
        $relElementConfigs = isset($configUiMasterModulJenis['relativeElements']) ? $configUiMasterModulJenis['relativeElements'] : array();
        $relOptionConfigs = isset($configUiMasterModulJenis['relativeOptions']) ? $configUiMasterModulJenis['relativeOptions'] : array();
        $noteEnabled = isset($configUiMasterModulJenis['shoppingCartNoteEnabled']) && $configUiMasterModulJenis['shoppingCartNoteEnabled'] == true ? true : false;
        $imageEnabled = isset($configUiMasterModulJenis['shoppingCartImageEnabled']) && $configUiMasterModulJenis['shoppingCartImageEnabled'] == true ? true : false;
        $addRowsConfigs = isset($configUiMasterModulJenis['additionalRows']) ? $configUiMasterModulJenis['additionalRows'] : array();
        $inputLabels = array();
        $rawPrevURL = isset($_GET['rawPrev']) ? $_GET['rawPrev'] : "";
        //--------------------------
        $shoppingCartAdvanceItems = isset($configUiMasterModulJenis['shoppingCartAdvanceItems']) ? $configUiMasterModulJenis['shoppingCartAdvanceItems'] : false;
        if ($shoppingCartAdvanceItems == true) {
            $shoppingCartAdvanceItemsKey = isset($configUiMasterModulJenis['shoppingCartAdvanceItemsKey']) ? $configUiMasterModulJenis['shoppingCartAdvanceItemsKey'] : NULL;
            $shoppingCartAdvanceFields = isset($configUiMasterModulJenis['shoppingCartAdvanceFields']) ? $configUiMasterModulJenis['shoppingCartAdvanceFields'] : array();
            $shoppingCartAdvanceNumFields = isset($configUiMasterModulJenis['shoppingCartAdvanceNumFields']) ? $configUiMasterModulJenis['shoppingCartAdvanceNumFields'] : array();
//            $shoppingCartAdvanceAmountValue = isset($configUiMasterModulJenis['shoppingCartAdvanceAmountValue']) ? $configUiMasterModulJenis['shoppingCartAdvanceAmountValue'] : array();
            $shoppingCartAdvanceSubFields = isset($configUiMasterModulJenis['shoppingCartAdvanceSubFields']) ? $configUiMasterModulJenis['shoppingCartAdvanceSubFields'] : array();
            $shoppingCartAdvanceSubNumFields = isset($configUiMasterModulJenis['shoppingCartAdvanceSubNumFields']) ? $configUiMasterModulJenis['shoppingCartAdvanceSubNumFields'] : array();
            $shoppingCartAdvanceSubEditableFields = isset($configUiMasterModulJenis['shoppingCartAdvanceSubEditableFields']) ? $configUiMasterModulJenis['shoppingCartAdvanceSubEditableFields'] : array();
            $shoppingCartAdvanceItemsSelector = isset($configUiMasterModulJenis['shoppingCartAdvanceItemsSelector']) ? $configUiMasterModulJenis['shoppingCartAdvanceItemsSelector'] : array();
            $shoppingCartAdvanceItemsRemove = isset($configUiMasterModulJenis['shoppingCartAdvanceItemsRemove']) ? $configUiMasterModulJenis['shoppingCartAdvanceItemsRemove'] : array();
            $shoppingCartAdvanceItemsAdd = isset($configUiMasterModulJenis['shoppingCartAdvanceItemsAdd']) ? $configUiMasterModulJenis['shoppingCartAdvanceItemsAdd'] : array();
...
//                    $advanceAmountItemsLabel = isset($shoppingCartAdvanceAmountValue[$key_result][$stepNumber]) ? $shoppingCartAdvanceAmountValue[$key_result][$stepNumber] : array();
                    ...
                    $shoppingCartAdvanceItemsLabel[$id] = $advanceItemsLabel + $advanceNumItemsLabel + array("subtotal" => "total price");
                    $shoppingCartAdvanceSubItemsLabel[$id] = $advanceSubItemsLabel + $advanceSubNumItemsLabel + array("subtotal" => "subtotal");
                    $shoppingCartAdvanceNumType[$id] = $advanceSubNumItemsLabel + array("subtotal" => "subtotal");
        ...
        if (sizeof($itemLabels) > 0) {
            $itemLabels = $itemLabels + array("subtotal" => "sub-amount");
        }
        $itemLabels2 = $itemLabels2 + $itemNumLabels2;
        if (sizeof($itemLabels2) > 0) {
            $itemLabels2 = $itemLabels2 + array("subtotal" => "sub-amount");
        }
        $itemLabels3 = $itemLabels3 + $itemNumLabels3;
        if (sizeof($itemLabels3) > 0) {
            $itemLabels3 = $itemLabels3 + array("subtotal" => "sub-amount");
        }
//        arrPrintKuning($itemLabels2);
//        arrPrintKuning($itemLabels3);
...
//arrPrint($master_item);
        //endregion


        if (isset($_SESSION[$cCode]["main"]["modePymSrc"]) && ($_SESSION[$cCode]["main"]["modePymSrc"] == "pymSrc")) {
            $itemLabels = isset($configUiMasterModulJenis['shoppingCartFieldsPymSrc'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartFieldsPymSrc'][$stepNumber] : array();
...
//            "sumRows" => isset($configUi[$this->jenisTr]['shoppingCartSumFields'][1]) ? $configUi[$this->jenisTr]['shoppingCartSumFields'][1] : $this->configLayout[$this->jenisTr]['receiptSumFields'][1],
            "sumRows" => isset($configUiMasterModulJenis['shoppingCartSumFields'][1]) ? $configUiMasterModulJenis['shoppingCartSumFields'][1] : $configLayoutMasterModulJenis['receiptSumFields'][1],
            ...
            "subAdvanceItems" => isset($_SESSION[$cCode]['items2']) ? $_SESSION[$cCode]['items2'] : array(),
        );
    ...
    public function save()
    {
        ...
        // region validasi lokasi masih di pusat/cabang
        $new_login_cabang_id = my_cabang_id();
        $new_login_cabang_nama = my_cabang_nama();
        $trans_login_cabang_id = isset($_SESSION[$cCode]["main"]["placeID"]) ? $_SESSION[$cCode]["main"]["placeID"] : 0;
        $trans_login_cabang_nama = isset($_SESSION[$cCode]["main"]["placeName"]) ? $_SESSION[$cCode]["main"]["placeName"] : 0;
        $trans_cabang_id = isset($_SESSION[$cCode]["main"]["transaksi__cabang_id"]) ? $_SESSION[$cCode]["main"]["transaksi__cabang_id"] : 0;
        $trans_cabang_nama = isset($_SESSION[$cCode]["main"]["transaksi__cabang_nama"]) ? $_SESSION[$cCode]["main"]["transaksi__cabang_nama"] : 0;

//        $new_login_cabang_id = "1";
//        $new_login_cabang_nama = "Jakarta";
//        $trans_cabang_id = "1";
//        $trans_cabang_nama = "Jakarta";

        if ($new_login_cabang_id != $trans_login_cabang_id) {
            ...
            $msg .= "Silahkan login ulang di cabang $trans_login_cabang_nama.";
//            mati_disini($msg);
        }
        if ($new_login_cabang_id != $trans_cabang_id) {
            $msg = "Transaksi gagal diselesaikan karena ";
            $msg .= "anda login di $new_login_cabang_nama, sedangkan transaksi berada di $trans_cabang_nama. ";
            $msg .= "Silahkan login ulang di cabang $trans_cabang_nama.";
//            mati_disini($msg);
        }
        // endregion validasi lokasi masih di pusat/cabang
        ...
        if (isset($_SESSION[$cCode])) {
            ...
            if (!isset($_SESSION[$cCode]["main"]["bookingNumber"])) {
                $msg = "Nomer Booking transaksi expired. (Silahkan refresh halaman ini untuk mendapatkan nomer booking baru dan ulangi proses simpan transaksi). code: " . __LINE__;
                matiAlert($msg);
            }
            elseif ($_SESSION[$cCode]["main"]["bookingNumber"] == null) {
                $msg = "Nomer/Kode Booking transaksi baru belum terdaftar. Silahkan refresh halaman ini. code: " . __LINE__;
                mati_disini($msg);
            }
            ...
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                ...
                if (sizeof($koreksi_serial) > 0) {
                    if (isset($_SESSION[$cCode]["items7_sum"]) && (sizeof($_SESSION[$cCode]["items7_sum"]) > 0)) {
                        ...
                        // disini adalah GRN lama, generate serial dan rekening serial saat PRE-GRN
                        if (isset($koreksi_serial["enabled"]) && ($koreksi_serial["enabled"] == true)) {
                            ...
                            if (in_array(ipadd(), $list_ip_addr)) {
                                ...
                                $addPostProcessor = isset($koreksi_serial["addPostProcessor"]) ? $koreksi_serial["addPostProcessor"] : array();
                                if (sizeof($koreksi_serial["addPostProcessor"]) > 0) {

                                    if (isset($_SESSION[$cCode]['revert']['postProc']['detail'])) {
                                        foreach ($addPostProcessor as $ii => $addPostProc) {
                                            $_SESSION[$cCode]['revert']['postProc']['detail'][$ii] = $addPostProc;
                                        }
                                    }
                                    else {
                                        foreach ($addPostProcessor as $addPostProc) {
                                            $_SESSION[$cCode]['revert']['postProc']['detail'][] = $addPostProc;
                                        }
                                    }
                                }
                                $_SESSION[$cCode]['main']['returns'] = 1;
                                $_SESSION[$cCode]['tableIn_master']['returns'] = 1;
                            }
                        }
                    }
                }
            ...
            $iterator = array();
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                $iterator = isset($_SESSION[$cCode]["revertAuto"]["preProcAuto"]['detail']) ? $_SESSION[$cCode]["revertAuto"]["preProcAuto"]['detail'] : array();
            }
...
//                                "selisih" => ($_SESSION[$cCode]["main"]["hpp"] + $_SESSION[$cCode]["main"]["ppn"]) - ($_SESSION[$cCode]["main"]["nett"] + $_SESSION[$cCode]["main"]["ppv"]),
                                "selisih" => (($_SESSION[$cCode]["main"]["hpp"] + $_SESSION[$cCode]["main"]["ppn"]) - ($_SESSION[$cCode]["main"]["nett"] + $_SESSION[$cCode]["main"]["ppv"])) * -1,
                                "hpp_nppv" => $_SESSION[$cCode]["main"]["hpp"],
                                "hpp_nppn" => $_SESSION[$cCode]["main"]["hpp"] + $_SESSION[$cCode]["main"]["ppn"],
                            );
                            break;
                    }
//                    cekHitam($_SESSION[$cCode]["main"]["hpp"]."+".$_SESSION[$cCode]["main"]["ppn"]." - ". $_SESSION[$cCode]["main"]["nett"]." + ".$_SESSION[$cCode]["main"]["ppv"]);
...
//                    matiHere();
            ...
            $iterator = array();
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                $iterator = isset($_SESSION[$cCode]["revertAuto"]["preProcAuto"]['master']) ? $_SESSION[$cCode]["revertAuto"]["preProcAuto"]['master'] : array();
            }
            if (sizeof($iterator) > 0) {
            ...
            if (sizeof($iterator) > 0) {
                ...
                $referensi_dibatalkan = isset($_SESSION[$cCode]["main"]["pihakExternMasterID"]) ? $_SESSION[$cCode]["main"]["pihakExternMasterID"] : NULL;

                $this->load->helper("he_value_builder");
//                fillValues_he_value_builder($this->jenisTr, 1, 1, $this->configCoreJenis, $this->configUiJenis, $this->configValuesJenis);
                fillValues_he_value_builder($this->jenisTr, 1, 1, $this->configCoreJenis, $this->configUiJenis, $this->configValuesJenis, $_SESSION[$cCode]["main"]["ppnFactor"], $referensi_dibatalkan);
                    ...
                    switch ($jenisTrReference) {
                        ...
                        case "461":
                            $tempCalculate = array(// selisih dari nilai nota pembelian dengan stok yang diambil pembatalan....
                                "selisih" => (($_SESSION[$cCode]["main"]["hpp"] + $_SESSION[$cCode]["main"]["ppn"]) - ($_SESSION[$cCode]["main"]["nett"])) * -1,
                                "hpp_nppv" => $_SESSION[$cCode]["main"]["hpp"],
                                "hpp_nppn" => $_SESSION[$cCode]["main"]["hpp"] + $_SESSION[$cCode]["main"]["ppn"],
                            );
                            break;
                        case "3333":
                            if ($_SESSION[$cCode]["main"]["hpp"] > 0) {
                                $tempCalculate = array(
                                    "selisih" => (($_SESSION[$cCode]["main"]["hpp"] + $_SESSION[$cCode]["main"]["ppn"]) - ($_SESSION[$cCode]["main"]["nilai_cancel"] + $_SESSION[$cCode]["main"]["ppv"])) * -1,
                                    "hpp_nppv" => $_SESSION[$cCode]["main"]["hpp"],
                                    "hpp_nppn" => $_SESSION[$cCode]["main"]["hpp"] + $_SESSION[$cCode]["main"]["ppn"],
                                    "nilai_persediaan" => $_SESSION[$cCode]["main"]["hpp"],
                                );
                                $_SESSION[$cCode]["main"]["nilai_persediaan"] = $_SESSION[$cCode]["main"]["hpp"];
                            }
                            break;
                        default:
                            /*
...
//                arrPrintWebs($iterator);
                ...
                $iterator = isset($this->configCore[$this->jenisTr]['preProcessor'][$jenisTrTarget]['sub_detail']) ? $this->configCore[$this->jenisTr]['preProcessor'][$jenisTrTarget]['sub_detail'] : array();
            }
                                        ...
                                        if (sizeof($gotParams) > 0) {//==gotParams means result from preprocessor
                                            foreach ($gotParams as $gateName => $paramSpec) {
                                                ...
                                                foreach ($paramSpec as $idx => $gSpec) {
                                                    //                                        $id = $gSpec['id'];
                                                    if (!isset($_SESSION[$cCode][$gateName][$xiID][$idx])) {
                                                        $_SESSION[$cCode][$gateName][$xiID][$idx] = array();
                                                    }

                                                    if (isset($_SESSION[$cCode][$gateName][$xiID][$idx])) {
                                                        if (is_array($gSpec) && sizeof($gSpec) > 0) {
                                                            foreach ($gSpec as $key => $val) {
                                                                $_SESSION[$cCode][$gateName][$xiID][$idx][$key] = $val;
                                                            }
                                                        }
                                                    }
                                                    //==inject gotParams to child gate
                                                    if ($gateName == $srcGateName) {
                                                        if (isset($_SESSION[$cCode][$srcGateName][$xiID][$idx])) {
                                                            if (is_array($gSpec) && sizeof($gSpec) > 0) {
                                                                foreach ($gSpec as $key => $val) {
                                                                    $_SESSION[$cCode][$srcGateName][$xiID][$idx][$key] = $val;
                                                                }
                                                            }
                                                        }
                                                    }
                                                    ...
                                                    if (sizeof($itemNumLabels) > 0) {
                                                        ...
                                                        foreach ($itemNumLabels as $key => $label) {
                                                            //cekHere("$id === $key => $label");
                                                            $_SESSION[$cCode][$gateName][$xiID][$idx]['sub_' . $key] = ($_SESSION[$cCode][$gateName][$xiID][$idx]['jml'] * $_SESSION[$cCode][$gateName][$xiID][$idx][$key]);
                                                            //                                        die();
                                                            arrprint($_SESSION[$cCode][$gateName][$xiID][$idx]);
                                                        }
                                                    }
                                                    else {
...
//            cekOrange("lolos validator @" . __LINE__ . " " . __METHOD__);
            ...
            if (isset($_SESSION[$cCode]['tableIn_master']) && sizeof($_SESSION[$cCode]['tableIn_master']) > 0) {
                ...
                //-------
                $_SESSION[$cCode]['tableIn_master']['reference_id'] = $_SESSION[$cCode]['main']['transaksi'];
                $_SESSION[$cCode]['tableIn_master']['reference_nomer'] = $_SESSION[$cCode]['main']['transaksi__nomer'];
                $_SESSION[$cCode]['tableIn_master']['reference_jenis'] = $_SESSION[$cCode]['main']['transaksi__jenis'];
                $_SESSION[$cCode]['tableIn_master']['reference_id_top'] = "";
                $_SESSION[$cCode]['tableIn_master']['reference_nomer_top'] = "";
                $_SESSION[$cCode]['tableIn_master']['reference_jenis_top'] = "";
                //-------
...
//                        "contents_intext" => isset($aSpec['contents_intext']) ? $aSpec['contents_intext'] : "",
            ...
            if (isset($_SESSION[$cCode]['tableIn_master_eppoint']) && sizeof($_SESSION[$cCode]['tableIn_master_eppoint']) > 0) {
                ...
                foreach ($arrReplacerEP as $keyy => $vall) {
                    $_SESSION[$cCode]['tableIn_master_eppoint'][$keyy] = $vall;
                }
                $tr = new MdlTransaksi();
                $epID = $tr->writeMainEntries_entryPoint($insertID, $_SESSION[$cCode]['main']['referenceID_master'], $_SESSION[$cCode]['tableIn_master_eppoint']);
                cekHitam("[$epID]");
                showLast_query("hitam");

            }

            if (isset($_SESSION[$cCode]['main']['referenceID']) && ($_SESSION[$cCode]['main']['referenceID'] > 0)) {
                $arrReplacerEP = array(
                    "cancel_id" => my_id(),
                    "cancel_name" => my_name(),
                    "cancel_dtime" => date("Y-m-d H:i:s"),
            ...
            $iterator = array();
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                $iterator = isset($_SESSION[$cCode]['revertAwal']['jurnalAwal']['detail']) ? $_SESSION[$cCode]['revertAwal']['jurnalAwal']['detail'] : array();
...
//                        echo "*sub component: $srcGateName, sending values <br>";
            ...
            $compValidators = ($this->config->item('transaksi_value_required_components') != null) ? $this->config->item('transaksi_value_required_components') : array();
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                $iterator = isset($_SESSION[$cCode]['revertAwal']['jurnalAwal']['master']) ? $_SESSION[$cCode]['revertAwal']['jurnalAwal']['master'] : array();
            }
            if (sizeof($iterator) > 0) {
...
//            mati_disini(__LINE__ . " SETOP... COMPONENT  TAMBAHAN AWAL");
            ...
            $iterator = array();
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                $iterator = isset($_SESSION[$cCode]['revertAuto']['jurnalAuto']['detail']) ? $_SESSION[$cCode]['revertAuto']['jurnalAuto']['detail'] : array();
                $revertedTarget = $_SESSION[$cCode]['main']['pihakExternID'];
            }
...
//                        echo "*sub component: $srcGateName, sending values <br>";
            ...
            $compValidators = ($this->config->item('transaksi_value_required_components') != null) ? $this->config->item('transaksi_value_required_components') : array();
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                $iterator = isset($_SESSION[$cCode]['revertAuto']['jurnalAuto']['master']) ? $_SESSION[$cCode]['revertAuto']['jurnalAuto']['master'] : array();
            }
            if (sizeof($iterator) > 0) {
                $componentConfig['master'] = $iterator;
                $cCtr = 0;
            ...
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                $iterator = isset($_SESSION[$cCode]['revertAuto']['postProcAuto']['detail']) ? $_SESSION[$cCode]['revertAuto']['postProcAuto']['detail'] : array();
            }
            if (sizeof($iterator) > 0) {
                foreach ($iterator as $cCtr => $tComSpec) {
                    $comName = $tComSpec['comName'];
...
//                        arrPrint($_SESSION[$cCode][$srcGateName]);
            ...
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                $iterator = isset($_SESSION[$cCode]['revertAuto']['postProcAuto']['detail']) ? $_SESSION[$cCode]['revertAuto']['postProcAuto']['master'] : array();
            }
            if (sizeof($iterator) > 0) {
                foreach ($iterator as $cCtr => $tComSpec) {
                    $comName = $tComSpec['comName'];
...
//                        echo "*sub component: $srcGateName, sending values <br>";
            ...
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                $iterator = isset($_SESSION[$cCode]['revert']['jurnal']['sub_detail']) ? $_SESSION[$cCode]['revert']['jurnal']['sub_detail'] : array();
                cekHitam("jurnal pakai revert");
            }
            else {
                $iterator = isset($this->configCore[$this->jenisTr]['components'][$jenisTrTarget]['sub_detail']) ? $this->configCore[$this->jenisTr]['components'][$jenisTrTarget]['sub_detail'] : array();
            ...
            if ($pakai_ini_cli == 1) {
                if (sizeof($iterator) > 0) {
                    ...
                    foreach ($iterator as $cCtr => $tComSpec) {
                        ...
                        $srcGateName = $tComSpec['srcGateName'];
                        $srcRawGateName = $tComSpec['srcRawGateName'];
                        echo "sub-detail component: $comName, initializing values <br>";
                        echo "<script>top.writeProgress('MENYIAPKAN DATA SUB-DETAIL COMPONENT UNTUK DIKIRIM...', 'head');</script>";

                        $tmpOutParams[$cCtr] = array();
                        if (isset($_SESSION[$cCode][$srcGateName]) && (sizeof($_SESSION[$cCode][$srcGateName]) > 0)) {

                            foreach ($_SESSION[$cCode][$srcGateName] as $cnt => $dDSpec) {
                                ...
                                foreach ($dDSpec as $idOP_spec => $dSpec) {
                                    ...
                                    if (isset($tComSpec['loop'])) {
                                        foreach ($tComSpec['loop'] as $key => $value) {
                                            ...
                                            $realValue = makeValue($value, $_SESSION[$cCode][$srcGateName][$cnt][$idOP_spec], $_SESSION[$cCode][$srcGateName][$cnt][$idOP_spec], 0);
                                            $subParams['loop'][$key] = $realValue;
                    ...
                    foreach ($iterator as $cCtr => $tComSpec) {
                        ...
                        $srcGateName = $tComSpec['srcGateName'];
                        $srcRawGateName = $tComSpec['srcRawGateName'];
                        echo "sub-detail component: $comName, sending values <br>";
                        echo "<script>top.writeProgress('SENDING DATA SUB-DETAIL COMPONENT ($comName)...', 'head');</script>";
                        if (isset($_SESSION[$cCode][$srcGateName]) && (sizeof($_SESSION[$cCode][$srcGateName]) > 0)) {
...
//
            ...
            if (sizeof($iterator) > 0) {
                ...
                foreach ($iterator as $cCtr => $tComSpec) {
                    ...
                    $srcRawGateName = $tComSpec['srcRawGateName'];
                    if (isset($_SESSION[$cCode][$srcGateName]) && (sizeof($_SESSION[$cCode][$srcGateName]) > 0)) {
                        echo "[$cCtr] sub-postProcessor: $comName, sending values **p**<br>";
...
//mati_disini(__LINE__ . " || SETOP...");
            ...
            //region SUBDETAIL postproc multi dimensional array /array 2 tinggkat
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                $iterator = isset($_SESSION[$cCode]['revert']['postProc']['sub_detail']) ? $_SESSION[$cCode]['revert']['postProc']['sub_detail'] : array();
                cekHitam("post procc pakai revert");
            }
            else {
                $iterator = isset($this->configCore[$this->jenisTr]['postProcessor'][$jenisTrTarget]['sub_detail']) ? $this->configCore[$this->jenisTr]['postProcessor'][$jenisTrTarget]['sub_detail'] : array();
                cekHitam("post procc pakai config core");
            }
...
//                                        "terbayar" => "nilai_bayar",
            ...
            if (isset($_SESSION[$cCode]["revert"]["connectedPaymentsourceUangMuka"]) && $_SESSION[$cCode]["revert"]["connectedPaymentsourceUangMuka"] == true) {
                cekBiru("mengembalikan payment source uang muka");
                $referenceStepNumber = $_SESSION[$cCode]["main"]["referenceStepNumber"];// transaksi id yang dibatalkan
                $keyRel = $_SESSION[$cCode]["main"]["referenceID"];// transaksi id yang dibatalkan
                $keyRelRef = $_SESSION[$cCode]["main"]["pihakExternID"];// jenis transaksi yang dibatalkan
                $relPaymentSrc = isset($this->config->item("uang_muka")[$keyRelRef][$referenceStepNumber]) ? $this->config->item("uang_muka")[$keyRelRef][$referenceStepNumber] : array();
                if (sizeof($relPaymentSrc) > 0) {
...
//                    $pym_uang_muka_pihak_id = $_SESSION[$cCode]["main"][$pym_uang_muka_pihak_id_key];
//                    $pym_uang_muka_dibatalkan = $_SESSION[$cCode]["main"][$pym_uang_muka_src];
//                    cekHitam("pihakid: $pym_uang_muka_pihak_id :: uangmuka batal: $pym_uang_muka_dibatalkan");
                    ...
                    if (count($relPaymentSrc) > 0) {
                        foreach ($relPaymentSrc as $i => $relPaymentSrc_0) {
                            ...
                            if (isset($_SESSION[$cCode]["main"][$value_labelSrc]) && $_SESSION[$cCode]["main"][$value_labelSrc] > 0) {
                                ...
                                if (isset($_SESSION[$cCode]["main"][$pym_uang_muka_extern2_id_key])) {
                                    $pym_uang_muka_extern2_id = $_SESSION[$cCode]["main"][$pym_uang_muka_extern2_id_key];
                                }
                                else {
                                    if (isset($_SESSION[$cCode]["main"]['referensi_so__id'])) {
                                        $pym_uang_muka_extern2_id = $_SESSION[$cCode]["main"]['referensi_so__id'];
                                    }
                                    else {
...
//                                matiHEre("ada $value_labelSrc :: nilainya ::".$_SESSION[$cCode]["main"][$value_labelSrc]);
...
//                matiHere();
            ...
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                $iterator = isset($_SESSION[$cCode]['revert']['postProc']['master']) ? $_SESSION[$cCode]['revert']['postProc']['master'] : array();
            }
            else {
            ...
            if (isset($this->configCore[$this->jenisTr]['relativeComponets']) && $this->configCore[$this->jenisTr]['relativeComponets'] == true) {
                ...
                $configUiMasterModulJenis = loadConfigModulJenis_he_misc($refMasterJenis, "coTransaksiUi");
                $configCoreMasterModulJenis = loadConfigModulJenis_he_misc($refMasterJenis, "coTransaksiCore");
                $configLayoutMasterModulJenis = loadConfigModulJenis_he_misc($refMasterJenis, "coTransaksiLayout");
                ...
                if (($stepnumAvail - $stepnum) > 0) {
                    ...
                    $dwsign = $tr->writeSignature($refMasterID, array(
                        ...
                        "step_code" => $configUiMasterModulJenis['steps'][abs($stepnum)]['target'],
                        "step_name" => $configUiMasterModulJenis['steps'][abs($stepnum)]['label'],
                        "group_code" => $configUiMasterModulJenis['steps'][abs($stepnum)]['userGroup'],
                        "oleh_id" => $this->session->login['id'],
                        "oleh_nama" => $this->session->login['nama'],
                        "keterangan" => $configUiMasterModulJenis['steps'][abs($stepnum)]['label'] . " oleh " . $this->session->login['nama'],
                        //            "transaksi_id" => $no,
                    )) or die("Failed to write signature");
                    $mongoList['sign'][] = $dwsign;
                    cekKuning($this->db->last_query() . " [" . $this->db->affected_rows() . "]");
            ...
            if (isset($_SESSION[$cCode]['main']['pihakExternRevertStep']) && ($_SESSION[$cCode]['main']['pihakExternRevertStep'] == true)) {
                ...
                if (sizeof($referenceNextProp) > 0) {
                    ...
                    $dupState = $tr->updateData(array("id" => $referenceNextProp['trID']), array(
                        ...
                        "returns" => $_SESSION[$cCode]["main"]["returns"],

                    )) or die("Failed to update tr next-state!");
                    cekHijau("BATAL :: " . $this->db->last_query() . " -- " . $this->db->affected_rows() . " ::: " . __LINE__);
            ...
            $baseRegistries = array(
                ...
                'rsltItems_revert' => isset($_SESSION[$cCode]['rsltItems_revert']) ? $_SESSION[$cCode]['rsltItems_revert'] : array(),
                'rsltItems2_revert' => isset($_SESSION[$cCode]['rsltItems2_revert']) ? $_SESSION[$cCode]['rsltItems2_revert'] : array(),
...
//            $this->lastValidate($insertID);
            ...
            cekHitam("MEMBATALKAN REFERENSI...");
            // membatalakan start project, update tabel project produk (kolom lock project, start _project dikosongkan).
            if (isset($_SESSION[$cCode]["main"]["jenisTr_reference"]) && ($_SESSION[$cCode]["main"]["jenisTr_reference"] != NULL)) {
                switch ($_SESSION[$cCode]["main"]["jenisTr_reference"]) {
                    case "588st":
                        $tr_id_dibatalkan = isset($_SESSION[$cCode]["main"]["transaksi"]) ? $_SESSION[$cCode]["main"]["transaksi"] : 0;
                        if ($tr_id_dibatalkan > 0) {// id start project...
                            $this->load->model("Mdls/MdlProdukProjectBatal");
                            $this->load->model("Mdls/MdlProdukProject");
                            $this->load->model("MdlTransaksi");

                            $p = new MdlProdukProject();
                            $p->setFilters(array());
                            $p->addFilter("project_start_id='$tr_id_dibatalkan'");
                            $tmpDataProject = $p->lookUpAll()->result();
                            showLast_query("kuning");
                            $project_id = $tmpDataProject[0]->id;
                            $project_nama = $tmpDataProject[0]->nama;
                            $customer_id = $tmpDataProject[0]->customer_id;
                            $customer_nama = $tmpDataProject[0]->customer_nama;

                            $t = new MdlTransaksi();
                            $t->setfilters(array());
                            $t->addFilter("jenis in ('5856','5855','3674','3675')");// fg, supplies
                            $t->addFilter("project_id='$project_id'");
                            $t->addFilterJoin("valid_qty>0");
                            $tmpDistriProject = $t->lookupJoined();
                            showLast_query("biru");
                            $trIDs_distribusi_bom = array();
                            if (count($tmpDistriProject) > 0) {
                                foreach ($tmpDistriProject as $tmpDistriProjectSpec) {
                                    $trIDs_distribusi_bom[$tmpDistriProjectSpec->id] = array(
                                        "id" => $tmpDistriProjectSpec->id,
                                        "nomer" => $tmpDistriProjectSpec->nomer,
                                    );
                                }
                            }

                            // update tabel produk_project
                            $p = new MdlProdukProject();
                            $p->setFilters(array());
                            $where = array(
                                "id" => $project_id,
                            ...
                            $p->updateData($where, $data) or mati_disini("Pembatalan gagal karena project tidak dikenal.");
                            showLast_query("orange");

                            // menulis tabel project batal
                            arrPrintPink($trIDs_distribusi_bom);
                            if (sizeof($trIDs_distribusi_bom) > 0) {
                                foreach ($trIDs_distribusi_bom as $ii => $iiSpec) {
                                    $data_batal = array(
                                        "nama" => $project_nama,
...
//                                        "project_start_name" => "",
                                        ...
                                        "transaksi_id" => $iiSpec["id"],
                                        "transaksi_no" => $iiSpec["nomer"],
                                        "dtime" => date("Y-m-d H:i:s"),
                                        "transaksi_dtime" => date("Y-m-d H:i:s"),
                                        "oleh_id" => my_id(),
                                        "oleh_nama" => my_name(),
                                    );
                                    $pb = New MdlProdukProjectBatal();
                                    $pb->setFilters(array());
                                    $pb->addData($data_batal);
                                    showLast_query("lime");
                                }
                            }
                            else {
                                cekMerah("BELUM ADA pengiriman material project...");
                            }
                        }
                    ...
                    case "5823spd":
                        ...
                        if ($tr_id_dibatalkan > 0) {// id 5822spd
                            $this->load->model("MdlTransaksi");

                            $t = new MdlTransaksi();
                            $t->setfilters(array());
                            $t->addFilter("reference_id='$tr_id_dibatalkan'");
                            $tTmp = $t->lookUpAll()->result();
                            showLast_query("biru");
                            if (sizeof($tTmp) > 0) {
                                foreach ($tTmp as $tSpec) {

                                    $trans_id_update = $tSpec->id;
                                    $trans_update_data = array(
                                        "trash_4" => 1,
                                        "deskripsi" => "rejection",
                                        "cancel_id" => my_id(),
                                        "cancel_name" => my_name(),
                                    ...
                                    $t = new MdlTransaksi();
                                    $t->setfilters(array());
                                    $tUpdate = $t->updateData($trans_update_where, $trans_update_data);
                                    showLast_query("orange");

                                    $trans_subupdate_data = array(
                                        "next_substep_code" => "",
                                        "next_substep_label" => "",
                                        "next_subgroup_code" => "",
                                        "valid_qty" => 0,
                                    );
                                    $trans_subupdate_where = array(
                                        "transaksi_id" => $trans_id_update,
                                    );
                                    $tru = new MdlTransaksi();
                                    $tru->setFilters(array());
                                    $tru->setTableName($tru->getTableNames()['detail']);
                                    $dupState = $tru->updateData($trans_subupdate_where, $trans_subupdate_data);
                                    showLast_query("orange");
                                }

                            }
                            else {
                                cekHitam("KOSONG___ " . __LINE__);
                            }

                            // memberikan trash_4=1 pada invoice 4822
                            $jenisTrInvoice = "4822";
                            $param = array(
                                "tr_id_dibatalkan" => $tr_id_dibatalkan,
                                "insert_id" => $insertID,
                                "insert_num" => $tmpNomorNota,
                                "oleh_id" => my_id(),
                                "oleh_nama" => my_name(),
                            ...
                            $lt->setJenisTrReference($jenisTrInvoice);
                            $lt->setJenisTrPembatalan($this->jenisTr);
                            $lt->setParam($param);
                            $lt->rejectInvoice();

                            if (($_SESSION[$cCode]["main"]["alasan_pembatalan__reject_jual_tunai"] == 1) && ($_SESSION[$cCode]["main"]["referenceID_penjualan_tunai"] > 0)) {
                                cekUngu("OTOMATIS MEMBATALKAN PENERIMAAN PENJUALAN TUNAI . trid (penerimaan penjualan tunai): " . $_SESSION[$cCode]["main"]["referenceID_penjualan_tunai"]);
                                $pihakTambahan = isset($this->configUi[$this->jenisTr]["pihakTambahan"][$pihakExternMasterID]["source"]) ? $this->configUi[$this->jenisTr]["pihakTambahan"][$pihakExternMasterID]["source"] : array();
                                $referenceTransaksiID = $_SESSION[$cCode]["main"]["referenceID_penjualan_tunai"];
                                $kiriman = array(
                                    "olehID" => my_id(),
                                    "olehName" => my_name(),
                                    "sellerID" => my_id(),
                                ...
                                if (sizeof($pihakTambahan) > 0) {
                                    foreach ($pihakTambahan as $aa => $bb) {
                                        $kiriman[$aa] = $bb;
                                    }
                                }
                                arrPrintCyan($kiriman);
//                                mati_disini(__LINE__);
                                $lt = New Transaksional();
                                $lt->autoPembatalan($this->jenisTr, $referenceTransaksiID, $kiriman);
                            }
                    ...
                    case "4821":
                        $tr_id_dibatalkan = isset($_SESSION[$cCode]["main"]["transaksi"]) ? $_SESSION[$cCode]["main"]["transaksi"] : 0;
                        cekHitam("MASUK DISINI [$tr_id_dibatalkan] || " . $_SESSION[$cCode]["main"]["jenisTr_reference"]);
                        if ($tr_id_dibatalkan > 0) {
                            $this->load->model("MdlTransaksi");
                            $t = new MdlTransaksi();
                            $t->setfilters(array());
                    ...
                    case "4467":
                        $tr_id_dibatalkan = isset($_SESSION[$cCode]["main"]["transaksi"]) ? $_SESSION[$cCode]["main"]["transaksi"] : 0;
                        cekKuning("MASUK DISINI [$tr_id_dibatalkan] || " . $_SESSION[$cCode]["main"]["jenisTr_reference"]);
                        if ($tr_id_dibatalkan > 0) {
                            if ($tr_id_dibatalkan > 0) {
                                $this->load->model("MdlTransaksi");
                                $t = new MdlTransaksi();
                    ...
                    case "4464":
                        ...
                        $jenisTrInvoice = "4822";
                        $tr_id_dibatalkan = isset($_SESSION[$cCode]["main"]["transaksi"]) ? $_SESSION[$cCode]["main"]["transaksi"] : 0;
                        cekHitam("[tr_id_dibatalkan: $tr_id_dibatalkan]");
                        if ($tr_id_dibatalkan > 0) {
                            $param = array(
                                "tr_id_dibatalkan" => $tr_id_dibatalkan,
                                "insert_id" => $insertID,
            ...
            // deteksi gunggungan mode == 1 dan jenis 111 ada tambahan untuk update items
            if ($_SESSION[$cCode]["main"]["gunggunganMode"] == 1) {
                $jenisTr_reference = $_SESSION[$cCode]["main"]["jenisTr_reference"];
                $referenceStepNumber = $_SESSION[$cCode]["main"]["referenceStepNumber"];
                $referenceStepNumberNew = $referenceStepNumber;
                switch ($jenisTr_reference) {
                    case "111":
                        $configUiMasterModulJenis = loadConfigModulJenis_he_misc($jenisTr_reference, "coTransaksiUi");
                        foreach ($_SESSION[$cCode]["items"] as $trid => $spec) {
                            $nextProp = array(
                                "num" => $referenceStepNumberNew,
                                "code" => $configUiMasterModulJenis['steps'][$referenceStepNumberNew]['target'],
                                "label" => $configUiMasterModulJenis['steps'][$referenceStepNumberNew]['label'],
                                "groupID" => $configUiMasterModulJenis['steps'][$referenceStepNumberNew]['userGroup'],
                            );
                            arrPrintCyan($nextProp);
                            $updateContents = array(
                                "valid_qty" => 1,
                                "valid_qty_no_approve" => 0,
                                "next_substep_num" => $nextProp["num"],
                                "next_substep_code" => $nextProp["code"],
                                "next_substep_label" => $nextProp["label"],
                                "next_subgroup_code" => $nextProp["groupID"],
...
//                                "sub_tail_code" => $this->configUi[$this->jenisTr]['steps'][$stepNum]['target'],
                            ...
                            $tru->setFilters(array());
                            $tru->setTableName($tru->getTableNames()['detail']);
                            $dupState = $tru->updateData($whereContents, $updateContents);
                            showLast_query("orange");

                            $updateContentsMain = array(
                                "next_step_num" => $nextProp["num"],
                                "next_step_code" => $nextProp["code"],
                                "next_step_label" => $nextProp["label"],
                                "next_group_code" => $nextProp["groupID"],
...
//                                "tail_code" => $this->configUi[$this->jenisTr]['steps'][$stepNum]['target'],
                            ...
                            $whereContentsMain = array(
                                "id" => $trid,
                            );
                            $tru = new MdlTransaksi();
                            $tru->setFilters(array());
                            $tru->setTableName($tru->getTableNames()['main']);
                            $dupState = $tru->updateData($whereContentsMain, $updateContentsMain);
                            showLast_query("orange");
            ...
            if ($_SERVER['REMOTE_ADDR'] == "202.65.117.72") {
                mati_disini("LINE: " . __LINE__ . " PEMBATALAN BERHASIL (saat ini sedang maintenance), tunggu beberapa saat lagi. TRID: $insertID");
            }
//            mati_disini("LINE: " . __LINE__ . " PEMBATALAN BERHASIL (saat ini sedang maintenance), tunggu beberapa saat lagi. TRID: $insertID");
                    ...
                    if (isset($printSettings['size'])) {
                        ...
                        switch ($printSettings['size']) {
                            case "normal":
                                ...
                                echo "<script>";
                                echo "top.popBig('" . MODUL_PATH . $printLocation . "$tmpNomorNota');";
...
//cekBiru($_SESSION[$cCode]['main'][$colName]);
    ...
    public function doEdit()
    {
        ...
        if (isset($_SESSION[$cCode])) {
            ...
            if (isset($_SESSION[$cCode]['mode']['edit']) && sizeof($_SESSION[$cCode]['mode']['edit']) > 0) {
                ...
                // mulai update transaksi_registry lama ke trash 1
...
//                                "contents_intext" => isset($aSpec['contents_intext']) ? print_r($aSpec['contents_intext'], true) : "",
            ...
            //            arrPrint( $masterID );
//
//            mati_disini("precancel packing under maintenance");
...
//                        cekkuning("detecting printing size");
    ...
    //------------------------------------------
    public function run_batalPembatalan()
    {
        $cCode = "_TR_" . $this->jenisTr;
        $id = $trid = "595940";
        $trno = "9912.1.470";
...
//                    $_SESSION[$cCode]['rsltItems2_revert'][$value['id']]['qty'] += $value['qty'];
        ...
        $arrSes = array(
            "pihakExternID" => "9912",
            "pihakExternMasterID" => "9912",
            "pihakExternName" => "PEMBATALAN TRANSAKSI",
            "pihakExternValueSrc" => "hpp",
            "pihakExternRevertStep" => 1,
            "pihakExternDetailGate" => "items",
            "pihakExternRevertRequest" => "",
            "jenis" => 9912,
            "transaksi_jenis" => 9912,
            "next_step_code" => "",
            "next_group_code" => "",
            "step_number" => 1,
            "step_current" => 0,
        ...
        $_SESSION[$cCode]["main"]["bookingNumber"] = $bookingNumber;
        //-----------------------------------------------------
        $_SESSION[$cCode]['main']['transaksi'] = $trid;
        $_SESSION[$cCode]['main']['transaksi__nomer'] = $trno;
        $_SESSION[$cCode]['main']['transaksi__jenis'] = $trjn;

        $_SESSION[$cCode]['revert']['jurnal']['master'] = array(
            array(
                "comName" => "Jurnal",
                "loop" => array(
                    "2010050" => "-(nilai_dipakai_2010050_2010050010+pym_src_dipakai)",// hutang ke konsumen
                    "1010020010" => "nilai_tambah_2010050_2010050010",// piutang dagang reguler
                    "1010020090" => "nilai_tambah_1010020090",// piutang dagang marketplace
            ...
            array(
                ...
                "static" => array(
                    "cabang_id" => "placeID",
                    "extern_id" => "marketplaceID",
                    "extern_nama" => "marketplaceName",
//                            "extern2_id" => "pihakID",
//                            "extern2_nama" => "pihakName",
            ...
            array(
                ...
                "static" => array(
                    ...
                    "extern_id" => "pihakID",
                    "extern_nama" => "pihakName",
                    "extern2_id" => "marketplaceID",
                    "extern2_nama" => "marketplaceName",
                    "jenis" => "jenisTr",
                    "transaksi_no" => "nomer",
                ),
                "srcGateName" => "main",
...
//                            "harga" => "nett1",
            ...
            // region pembantu penjualan reguler, marketplace
            // endregion pembantu penjualan reguler, marketplace
            ...
            //bagian jurnal paket untuk keluarin hpp ->persediaan
            array(
                "comName" => "Jurnal",
                "loop" => array(
            ...
            array(
                "comName" => "RekeningPembantuHpp",
                "loop" => array(
                    "5010" => "(hpp_paket+ppv_riil_paket)-harga_jasa_paket",// hpp
                ),
                "static" => array(
                    "cabang_id" => "placeID",
                    "extern_id" => ".5010010",
                    ...
                    "jenis" => "jenisTr",
                    "transaksi_no" => "nomer",
                    "harga" => "(hpp_paket+ppv_riil_paket)-harga_jasa_paket",
                ),
                "srcGateName" => "main",
                "srcRawGateName" => "main",
            ),

            //tambahan jurnal hpp riil pada persediaan rill hanya terjadi dipusat auto geser non paket
            array(
                "comName" => "Jurnal",
                "loop" => array(
                    "8020" => "-hpp_riil",//persediaan produk riil
                    "5030" => "hpp_riil",//persediaan produk riil
                ),
                "static" => array(
                    "cabang_id" => ".-1",//langsung diousat karena persediaan rill ada dipusat
                    "jenis" => "jenisTr",
                    "transaksi_no" => "nomer",
                ),
                "srcGateName" => "main",
            ...
            //tambahan jurnal hpp riil pada persediaan rill hanya terjadi dipusat auto geser paket
            array(
                "comName" => "Jurnal",
                "loop" => array(
                    "8020" => "-hpp_paket_riil",//persediaan produk riil
                    "5030" => "hpp_paket_riil",//persediaan produk riil
                ),
                "static" => array(
                    "cabang_id" => ".-1",//langsung diousat karena persediaan rill ada dipusat
                    "jenis" => "jenisTr",
        ...
        $_SESSION[$cCode]['revert']['jurnal']['detail'] = array(
            array(
...
//                        "srcRawGateName" => "items",
            ...
            //rekening pembantu hpp riil reguler
            array(
                "comName" => "RekeningPembantuHppRiilItem",
                "loop" => array(
                    "5030" => "sub_hpp_riil",//persediaan produk riil
                ),
                "static" => array(
                    "cabang_id" => ".-1",
                    "extern_id" => "id",
...
//                        "srcRawGateName" => "items",
        ...
        $_SESSION[$cCode]['revert']['jurnal']['sub_detail'] = array(
            //rekening pembantu produk dari paket
            array(
                "comName" => "RekeningPembantuProduk",
                "loop" => array(
            ...
            //rekening pembantu produk riil
            array(
//                        "comName" => "RekeningPembantuProduk",
                "comName" => "RekeningPembantuProdukRiil",
                "loop" => array(
//                            "8020" => "-sub_hpp_paket_riil",// persediaan produk
                    "8020" => "-sub_hpp_riil_paket",// persediaan produk
                ),
                "static" => array(
                    "cabang_id" => ".-1",
                    "extern_id" => "id",
            ...
            //rekening pembantu hpp riil paket
            array(
                "comName" => "RekeningPembantuHppRiilItem",
                "loop" => array(
                    "5030" => "sub_hpp_paket_riil",//persediaan produk riil
                ),
                "static" => array(
                    "cabang_id" => ".-1",
                    "extern_id" => "id",
        ...
        $_SESSION[$cCode]['revert']['postProc']['detail'] = array(
...
//                            "supplierID" => "pihakID",
            ...
            // rekening pembantu produk serial paket intransit
            array(
...
//                            "supplierID" => "pihakID",
        ...
        $_SESSION[$cCode]['revert']['postProc']['sub_detail'] = array(
            array(
                "comName" => "LockerStock",
                "loop" => array(),
                "static" => array(
        ...
        $_SESSION[$cCode]['revert']['postProc']['master'] = array(
