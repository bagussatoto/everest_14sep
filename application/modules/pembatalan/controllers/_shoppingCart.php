...
//        cekHere(":: $jenisTr_reference_trans :: $stepNumber ::");
//        arrPrintKuning($configUiMasterModulJenis);
        ...
        $minValue = array();
        $itemLabels = array();
        $shoppingCartFieldSrc = isset($configUiMasterModulJenis['shoppingCartFieldSrc']) ? $configUiMasterModulJenis['shoppingCartFieldSrc'] : array();
        ...
        $itemsLabelReplacer = isset($configUiMasterModulJenis['shopingCartFieldsReplacer']) ? $configUiMasterModulJenis['shopingCartFieldsReplacer'] : array();
        if (isset($_SESSION[$cCode]['main']['references']) || isset($_SESSION[$cCode]['main']['singleReference'])) {
            $itemLabels = isset($configUiMasterModulJenis['shoppingCartFieldsExt'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartFieldsExt'][$stepNumber] : $itemLabels;
        }
        $shoppingCartFieldsSubItems = isset($configUiMasterModulJenis['shoppingCartFieldsSubItems'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartFieldsSubItems'][$stepNumber] : array();
...
//        $editableFields = isset($configUiMasterModulJenis['shoppingCartEditableFields'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartEditableFields'][$stepNumber] : array();
//        $editableFields2 = isset($configUiMasterModulJenis['shoppingCartEditableFields2'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartEditableFields2'][$stepNumber] : array();
//        $editableFieldsCompare = isset($configUiMasterModulJenis['shopingCartEditableCompare'][$stepNumber]) ? $configUiMasterModulJenis['shopingCartEditableCompare'][$stepNumber] : array();
        $editableFields = array();
        $editableFields2 = array();
        $editableFieldsCompare = array();
        $shoppingCartMainEditableFields = array();
//        $shoppingCartMainEditableFields = isset($configUiMasterModulJenis['shoppingCartMainEditableFields'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartMainEditableFields'][$stepNumber] : array();
        $shoppingCartAmountValue = isset($configUiMasterModulJenis['shoppingCartAmountValue'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartAmountValue'][$stepNumber] : array();
        ...
        $receiptElementsTambahan = isset($this->configUi[$this->jenisTr]['receiptElementsTambahan'][$_SESSION[$cCode]["main"]["pihakExternMasterID"]]) ? $this->configUi[$this->jenisTr]['receiptElementsTambahan'][$_SESSION[$cCode]["main"]["pihakExternMasterID"]] : array();
        ...
        $editHandlerMethod = isset($configUiMasterModulJenis['editHandlerMethod']) ? $configUiMasterModulJenis['editHandlerMethod'] : "blabla";
        $editHandlerMethod2 = isset($configUiMasterModulJenis['editHandlerMethod2']) ? $configUiMasterModulJenis['editHandlerMethod2'] : "";
        $editMainHandlerMethod = isset($configUiMasterModulJenis['editMainHandlerMethod']) ? $configUiMasterModulJenis['editMainHandlerMethod'] : NULL;
        $editMainHandlerMethod2 = isset($configUiMasterModulJenis['editMainHandlerMethod2']) ? $configUiMasterModulJenis['editMainHandlerMethod2'] : NULL;
        ...
        $noteType = isset($configUiMasterModulJenis['shoppingCartNoteType']) ? $configUiMasterModulJenis['shoppingCartNoteType'] : "text";
        $imageEnable = isset($configUiMasterModulJenis['shoppingCartImageEnabled']) ? $configUiMasterModulJenis['shoppingCartImageEnabled'] : false;
        $showScheme = isset($configUiMasterModulJenis['shoppingCartShowScheme']) ? $configUiMasterModulJenis['shoppingCartShowScheme'] : false;
        $imageType = isset($configUiMasterModulJenis['shoppingCartImageType']) ? $configUiMasterModulJenis['shoppingCartImageType'] : "blaa";
        $pairedItemEnabled = isset($configUiMasterModulJenis['shoppingCartPairedItem']['enabled']) && $configUiMasterModulJenis['shoppingCartPairedItem']['enabled'] == true ? true : false;
        $pairedItem = isset($configUiMasterModulJenis['shoppingCartPairedItem']) ? $configUiMasterModulJenis['shoppingCartPairedItem'] : array();
        $pairedItemTarget = isset($configUiMasterModulJenis['shoppingCartPairedItem']['targetGateName']) ? $configUiMasterModulJenis['shoppingCartPairedItem']['targetGateName'] : "items2";
        $pairedItemField = isset($configUiMasterModulJenis['shoppingCartFieldsPairedItem'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartFieldsPairedItem'][$stepNumber] : array();
        $pairedItemRecorder = isset($configUiMasterModulJenis['shoppingCartPairedItemRecorder']) ? $configUiMasterModulJenis['shoppingCartPairedItemRecorder'] : "";
        $pairedMoq = isset($configUiMasterModulJenis['shoppingCartMinFields'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartMinFields'][$stepNumber] : array();
        $avoidRemove = isset($configUiMasterModulJenis['shoppingCartAvoidRemove']) ? $configUiMasterModulJenis['shoppingCartAvoidRemove'] : false;
        $tmpSaver = isset($configUiMasterModulJenis['tmpSave']) ? $configUiMasterModulJenis['tmpSave'] : array();
        $reqDiskon = isset($configUiMasterModulJenis['reqDiskon']) ? $configUiMasterModulJenis['reqDiskon'] : array();
        $unionSelectors = isset($configUiMasterModulJenis['shoppingCartUnionSelectors'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartUnionSelectors'][$stepNumber] : array();
        $keyUpEvents = isset($configUiMasterModulJenis['shoppingCartKeyUpEvents'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartKeyUpEvents'][$stepNumber] : array();
        $selectedPrices = isset($configUiMasterModulJenis['selectedPrice']['key_label']) ? $configUiMasterModulJenis['selectedPrice']['key_label'] : array();
        $showItems = isset($configUiMasterModulJenis['showItems']) && $configUiMasterModulJenis['showItems'] == "false" ? "false" : "true";
...
//        $fixedNote = isset($configLayoutMasterModulJenis['fixedNote']) ? $configLayoutMasterModulJenis['fixedNote'] : null;
//        $fixedNoteTop = isset($configLayoutMasterModulJenis['fixedNoteTop']) ? $configLayoutMasterModulJenis['fixedNoteTop'] : null;
        $fixedNote = null;
        $fixedNoteTop = null;
        $shopingCartParamForceEditable = isset($configUiMasterModulJenis['shopingCartParamForceEditable'][$stepNumber]) ? $configUiMasterModulJenis['shopingCartParamForceEditable'][$stepNumber] : array();
        ...
        //----------------------------------------------
        $isSettlement = isset($configUiMasterModulJenis['isSettlement']) ? $configUiMasterModulJenis['isSettlement'] : false;
        $shopingCartReload = isset($configUiMasterModulJenis['shopingCartReload']) ? $configUiMasterModulJenis['shopingCartReload'] : false;
        //----------------------------------------------
...
//                    $advanceAmountItemsLabel = isset($shoppingCartAdvanceAmountValue[$key_result][$stepNumber]) ? $shoppingCartAdvanceAmountValue[$key_result][$stepNumber] : array();
        ...
        if (isset($_SESSION[$cCode])) {
            if (isset($_SESSION[$cCode]['items'])) {
                ...
                foreach ($_SESSION[$cCode]['items'] as $id => $iSpec) {
                    ...
                    $tmp['last_stock_avail'] = isset($iSpec['last_stock_avail']) ? $iSpec['last_stock_avail'] : 0;

                    $tmp["editTarget"] = base_url() . (isset($iSpec['handler']) ? str_replace("Selectors/", "pembatalan/", $iSpec['handler']) : '0') . "/" . $editHandlerMethod . "/" . $this->jenisTr . "?id=" . $id . "&newQty=";
                    $tmp["removeTarget"] = base_url() . (isset($iSpec['handler']) ? str_replace("Selectors/", "pembatalan/", $iSpec['handler']) : '0') . "/remove/" . $this->jenisTr . "?id=" . $id;
        ...
        if (isset($configUiMasterModulJenis['shoppingCartSubamount2']) && $configUiMasterModulJenis['shoppingCartSubamount2'][$stepNumber] == true) {
            ...
            if (sizeof($itemLabels2) > 0) {
                $itemLabels = $itemLabels + array("subtotal" => "Total Price");
            }
            $itemLabels2 = $itemLabels2 + $itemNumLabels2;
            if (sizeof($itemLabels2) > 0) {
                $itemLabels2 = $itemLabels2 + array("subtotal" => "Total Price");
            }
            $itemLabels3 = $itemLabels3 + $itemNumLabels3;
            if (sizeof($itemLabels3) > 0) {
                $itemLabels3 = $itemLabels3 + array("subtotal" => "Total Price");
            }
        }
        if (isset($configUiMasterModulJenis['shoppingCartHideSubamount']) && $configUiMasterModulJenis['shoppingCartHideSubamount'][$stepNumber] == true) {
...
//        if (isset($configUiMasterModulJenis['referenceJenisTr']) && strlen($configUiMasterModulJenis['referenceJenisTr']) > 1) {
//            $refJenisTr = $configUiMasterModulJenis['referenceJenisTr'];
            if (isset($configUiMasterModulJenis['referenceJenisTr']) && strlen($configUiMasterModulJenis['referenceJenisTr']) > 1) {
                $refJenisTr = $configUiMasterModulJenis['referenceJenisTr'];
...
onblur=\"if(this.value!=this.defaultValue){if(this.value.length<1){this.value='$initValue'};hiliteDiv(this);top.$('#result').load($selectorTarget);}\">";
        ...
        //bersihkan elemen yang tidak relevan, fitur ini dinonaktifkan karena gerbang session kosong 30 juni 2026
        $pakai_ini = 0;
        if ($pakai_ini == 1) {
...
//arrPrint($master_item);
        ...
        $jenisTr_reference_pihak = $_SESSION[$cCode]["main"]["pihakExternID"];
        $transaksi_pembatalanChecker = isset($this->configUi[$this->jenisTr]['transaksi_pembatalanChecker'][$jenisTr_reference_pihak]) ? $this->configUi[$this->jenisTr]['transaksi_pembatalanChecker'][$jenisTr_reference_pihak] : array();
        if (sizeof($transaksi_pembatalanChecker) > 0) {
            $sourceMain = $transaksi_pembatalanChecker["sourceMain"];//extracted_serial_diff
            $sourceDetail = $transaksi_pembatalanChecker["sourceDetail"];//diff_serial
            $sourceDetailProduk = $transaksi_pembatalanChecker["sourceDetailProduk"];//diff_serial_produk
            $sourceAllDetailProduk = $transaksi_pembatalanChecker["sourceAllDetailProduk"];//all_serial_produk
            $sourceLabel = $transaksi_pembatalanChecker["label"];
            $sourceDetailData = isset($_SESSION[$cCode][$sourceMain][$sourceDetail]) ? $_SESSION[$cCode][$sourceMain][$sourceDetail] : array();
            $sourceDetailDataProduk = isset($_SESSION[$cCode][$sourceMain][$sourceDetailProduk]) ? $_SESSION[$cCode][$sourceMain][$sourceDetailProduk] : array();
            //------
            $sourceAllDetailDataProduk = isset($_SESSION[$cCode][$sourceMain][$sourceAllDetailProduk]) ? $_SESSION[$cCode][$sourceMain][$sourceAllDetailProduk] : array();
            //------
            $koreksi_serial = isset($this->configUi[$this->jenisTr]['koreksi_serial'][$jenisTr_reference_pihak]) ? $this->configUi[$this->jenisTr]['koreksi_serial'][$jenisTr_reference_pihak] : array();
            if (sizeof($koreksi_serial) > 0) {
                if (isset($koreksi_serial["enabled"]) && ($koreksi_serial["enabled"] == true)) {
                    $list_ip_addr = $koreksi_serial["ipaddr"];
                    $koreksi_serial_label = $koreksi_serial["label"];
                    $koreksi_link = $koreksi_serial["link"] . "/" . $this->jenisTr . "/";
                    $moved_serial_link = MODUL_PATH . $koreksi_serial["movedLink"] . "/" . $this->jenisTr . "/";
//                    if (in_array(ipadd(), $list_ip_addr)) {
                    if ($this->session->login['ghost'] == 1) {
                        $allowed_koreksi_serial = true;
                    }
                    $arrDaftarSerialKoreksi = $_SESSION[$cCode]["items2"];
                }
            }
        }
        //-------------------------------------------------------------------------------
        ...
        //fitur ini dinonaktifkan karena gerbang session kosong 30 juni 2026
        $pakai_ini = 0;
        if ($pakai_ini == 1) {
            $addTableInMasterToMain = isset($this->configUi[$this->jenisTr]["addTableInMasterToMain"]) ? $this->configUi[$this->jenisTr]["addTableInMasterToMain"] : array();
            if (sizeof($addTableInMasterToMain) > 0) {
                foreach ($addTableInMasterToMain as $src => $target) {
                    if (!isset($_SESSION[$cCode]["main"][$target])) {
                        cekPink("masuk disini $target");
                        $_SESSION[$cCode]["main"][$target] = isset($_SESSION[$cCode]["tableIn_master_values"][$src]) ? $_SESSION[$cCode]["tableIn_master_values"][$src] : "";
                    }
                }
            }
        }
...
//        mati_disini(__LINE__);
        if (isset($_SESSION[$cCode]["main"]["label_notif"]) && ($_SESSION[$cCode]["main"]["label_notif"] != NULL)) {
            $fixedNote = $_SESSION[$cCode]["main"]["label_notif"];
        }

//        if (isset($_SESSION[$cCode]['main_elements']['cash_account']) && sizeof($_SESSION[$cCode]['main_elements']['cash_account']) > 0) {
//            $blobDecodeMain = blobDecode($_SESSION[$cCode]['main_elements']['cash_account']['contents']);
////            arrPrintWebs($blobDecodeMain);
//            $_SESSION[$cCode]["main"]["cash_account"] = $_SESSION[$cCode]['main_elements']['cash_account']['key'];
//            $_SESSION[$cCode]["main"]["cash_account__label"] = $blobDecodeMain["nama"];
//            $_SESSION[$cCode]["main"]["cash_account__nama"] = $blobDecodeMain["nama"];
//            $_SESSION[$cCode]["main"]["cash_account__folders"] = $blobDecodeMain["folders"];
//            $_SESSION[$cCode]["main"]["cash_account__folders_nama"] = $blobDecodeMain["folders_nama"];
//        }
        ...
        $shoppingCartKeterangan = isset($this->configUi[$this->jenisTr]['shoppingCartKeterangan'][$jenisTr_reference_pihak]) ? $this->configUi[$this->jenisTr]['shoppingCartKeterangan'][$jenisTr_reference_pihak] : array();
        if(sizeof($shoppingCartKeterangan)>0){
            $label_head = $shoppingCartKeterangan["label_head"];
            $label_sub = $shoppingCartKeterangan["label_sub"];
            $fixedNoteTop = str_replace("{referenceNomer}", $_SESSION[$cCode]["main"]["referenceNomer"],  $label_head);
            $fixedNoteTop .= $label_sub;
        }
        ...
        $data = array(
            ...
            //            "itemLabels"=>$itemLabels,
            "sumRows" => isset($configUiMasterModulJenis['shoppingCartSumFields'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartSumFields'][$stepNumber] : $configLayoutMasterModulJenis['receiptSumFields'][$stepNumber],
            "sumRows2" => $sumRows2,
            "sumRows3" => isset($configUiMasterModulJenis['shoppingCartSumFields3'][$stepNumber]) ? $configUiMasterModulJenis['shoppingCartSumFields3'][$stepNumber] : isset($configLayoutMasterModulJenis['receiptSumFields3'][$stepNumber]) ? $configLayoutMasterModulJenis['receiptSumFields3'][$stepNumber] : array(),
            "sumSpec2" => $sumSpec2,
            "sumType2" => $sumType2,
            "sumRowAction" => base_url() . "ValueGate/evalFees/" . $this->jenisTr,
            ...
            "isi_modal" => "",
            "keyupAction" => isset($configUiMasterModulJenis['keyupAction']) ? $configUiMasterModulJenis['keyupAction'] : false,
            "fixedNote" => $fixedNote,
            ...
            "headerMainByTransaksi" => isset($configUiMasterModulJenis['settlementHeaderByTransaksi'][$stepNumber]) ? $configUiMasterModulJenis['settlementHeaderByTransaksi'][$stepNumber] : array(),

            "headerByTransaksi" => isset($configUiMasterModulJenis['settlementByTransaksi'][$stepNumber]) ? $configUiMasterModulJenis['settlementByTransaksi'][$stepNumber] : array(),
            "headerByMenu" => isset($configUiMasterModulJenis['settlementByMenu'][$stepNumber]) ? $configUiMasterModulJenis['settlementByMenu'][$stepNumber] : array(),
            "headerByProduk" => "",
            "headerByBahan" => isset($configUiMasterModulJenis['settlementByBahan'][$stepNumber]) ? $configUiMasterModulJenis['settlementByBahan'][$stepNumber] : array(),
            "headerByPayment" => isset($configUiMasterModulJenis['settlementByPayment'][$stepNumber]) ? $configUiMasterModulJenis['settlementByPayment'][$stepNumber] : array(),

            "summaryByTransaksi" => isset($configUiMasterModulJenis['summaryByTransaksi'][$stepNumber]) ? $configUiMasterModulJenis['summaryByTransaksi'][$stepNumber] : array(),
            "labelByMenu" => isset($configUiMasterModulJenis['labelByMenu'][$stepNumber]) ? $configUiMasterModulJenis['labelByMenu'][$stepNumber] : array(),
            "labelByTransaksi" => isset($configUiMasterModulJenis['labelByTransaksi'][$stepNumber]) ? $configUiMasterModulJenis['labelByTransaksi'][$stepNumber] : array(),
            "labelByPayment" => isset($configUiMasterModulJenis['labelByPayment'][$stepNumber]) ? $configUiMasterModulJenis['labelByPayment'][$stepNumber] : array(),
            "labelByBahan" => isset($configUiMasterModulJenis['labelByBahan'][$stepNumber]) ? $configUiMasterModulJenis['labelByBahan'][$stepNumber] : array(),
            "labelTotal" => "",
            ...
            //--------------------------------------------
            "diffSerialData" => isset($sourceDetailData) ? $sourceDetailData : array(),
            "diffSerialLabel" => isset($sourceLabel) ? $sourceLabel : array(),
            "diffSerialDataProduk" => isset($sourceDetailDataProduk) ? $sourceDetailDataProduk : array(),
            "diffSerialLink" => isset($moved_serial_link) ? $moved_serial_link : "",
            //--------------------------------------------
            "allowed_koreksi_serial" => isset($allowed_koreksi_serial) ? $allowed_koreksi_serial : false,
            "sourceAllDetailDataProduk" => isset($sourceAllDetailDataProduk) ? $sourceAllDetailDataProduk : array(),
            "sourceAllDetailDataProdukLabel" => isset($koreksi_serial_label) ? $koreksi_serial_label : "",
            "koreksi_link" => isset($koreksi_link) ? $koreksi_link : "",
            "arrDaftarSerialKoreksi" => isset($arrDaftarSerialKoreksi) ? $arrDaftarSerialKoreksi : "",
            //--------------------------------------------
            "showLastStock" => isset($_SESSION[$cCode]["main"]["showLastStock"]) ? $_SESSION[$cCode]["main"]["showLastStock"] : 0,
            "showLastStockFields" => isset($this->configUi[$this->jenisTr]['showLastStockFields']) ? $this->configUi[$this->jenisTr]['showLastStockFields'] : array(),
            //--------------
...
//            "shoppingCartAdvanceItemsAdd" => isset($shoppingCartAdvanceItemsAdd) ? MODUL_PATH . $shoppingCartAdvanceItemsAdd . "/" . $this->jenisTr : array(),
        ...
        if (isset($previewJurnalConfig["enabled"]) && $previewJurnalConfig["enabled"] == true) {
            $previewJurnal = previewJurnal_he_accounting($this->jenisTr, $this->configUiJenis);
...
//            fillValues_he_value_builder($this->jenisTr, 1, 1, $configCoreMasterModulJenis, $configUiMasterModulJenis, array(), my_ppn_factor());
    ...
    public function reset()
    {
        ...
        $lt->execLocker($_SESSION[$cCode]['main'], 0, $_SESSION[$cCode]["main"]["transaksi"], NULL);
...
//        mati_disini("cek pID: $pID");
    ...
    public function koreksiSerial()
    {
        $cCode = $this->cCode;
        $old_serial = trim($_GET['old']);
        $new_serial = trim($_GET['new']);
        $pid = trim($_GET['pid']);
        $sku = trim($_GET['sku']);

//        mati_disini("cek [$pid] [$sku] [$old_serial] " . __LINE__);
        ...
        //cek locker serial, ready atau tidak-----------------------
        ...
        $srcs = $pps->lookupJoinSearchProdukSerial($new_serial)->result_array();
        $jml_srcs = count($srcs);
        $produk_speks = $srcs[0];
        $jml_serial = $produk_speks["jml_serial"];
        if (($jml_srcs == 1) && ($jml_serial == 1)) {

        }
        elseif (($jml_srcs == 1) && ($jml_serial > 0)) {

        }
        else {
            matiAlert("Nomer serial yang anda isikan tidak terdaftar. ", __LINE__);
        }

        $cekRekSerial = fetchRekeningSerialNumber($new_serial, my_cabang_id(), my_gudang_id());
        if ($cekRekSerial == false) {
            $msg = "Nomer serial $new_serial tidak terdaftar di " . my_cabang_nama() . ", gudang " . my_gudang_nama() . ", atau sudah dipakai. ";
            $msg .= " Silahkan ganti nomer serial lain atau hubungi admin";
            matiAlert($msg, __LINE__);
        }
        //-----------------------

        if (isset($_SESSION[$cCode]["items2"][$pid][$sku][$old_serial])) {
            $old_data = $_SESSION[$cCode]["items2"][$pid][$sku][$old_serial];
            // replace serial lama dengan serial baru
            $old_data["serial"] = $new_serial;

            $_SESSION[$cCode]["items2"][$pid][$sku][$old_serial] = NULL;
            unset($_SESSION[$cCode]["items2"][$pid][$sku][$old_serial]);

            $_SESSION[$cCode]["items2"][$pid][$sku][$new_serial] = $old_data;
            ...
            if (isset($_SESSION[$cCode]["items7_sum"]) && (sizeof($_SESSION[$cCode]["items7_sum"]) > 0)) {
                ...
                foreach ($_SESSION[$cCode]["items7_sum"] as $iix => $iixSpec) {
                    if ($old_serial == $iixSpec["produk_serial_number_2"]) {
                        $_SESSION[$cCode]["items7_sum"][$iix]["produk_serial_number_2"] = $new_serial;
                        $_SESSION[$cCode]["items7_sum"][$iix]["produk_serial"] = $new_serial;
                        break;
                    }
                }
            }
...
//            }
            ...
            foreach ($_SESSION[$cCode]["items2"] as $pid => $pSpec) {
                foreach ($pSpec as $sku => $skuSpec) {
                    foreach ($skuSpec as $sSpec) {
                        $detail3_sum = array(
                            "id" => $_SESSION[$cCode]["items"][$pid]["id"],
                            "nama" => $_SESSION[$cCode]["items"][$pid]["nama"],
                            "name" => $_SESSION[$cCode]["items"][$pid]["name"],
                            ...
                            "serial_number" => $sSpec["serial"],
                            "produk_serial" => $sSpec["serial"],
                            "produk_sku" => $sku,
                            "produk_sku_serial" => $sSpec["sku_serial"],
    ...
    public function viewMoveSerial()
    {
