...
//            "jml" => "qty",
    ...
    "3344" => array(
        "icon" => "fa fa-cart-arrow-down",
        "label" => "TAMBAHAN DISKON OLEH SUPPLIER (REBATE/MENDAPAT BARANG)",
...
//                "diskon_supplier_nilai" => "Total",//before
                ...
                "nilai_pph23" => "(pph23)",
                "grandtotal_netto" => "grand total",
                "nilai_dpp_pengganti" => "dpp pengganti",
                "nilai_ppn" => "ppn",
            ),
        ),
        "shoppingCartSubDetailFields" => array(
...
//              "mdlName" => "MdlPph23MethodPotongan",
                    ...
                    "ppnMethode" => array(
                        "elementType" => "dataModel",
                        "inputType" => "radio",
                        "label" => "PPN Masukan (PM / NON PM)",
                        "labelNotif" => "Adanya PPN dan tanpa PPN berdampak pada Jurnal",
...
//        ),
        "addMainSource" => array(
            1 => array(
                "fields" => array(
//                    "produk_rel_harga_dpp" => "Dasar Pengenaan pajak",
//                    "produk_rel_harga_dpp_pengganti" => "DPP pengganti(DPP Lain)",
//                    "produk_rel_harga_ppn" => "Ppn",
                    "dpp_final" => "Dasar Pengenaan pajak",
                    "dpp_pengganti" => "DPP pengganti(DPP Lain)",
                    "ppn_final" => "Ppn",
                    "produk_rel_harga" => "Total",
                    "dateFaktur" => "Tgl faktur ",
...
//                        "label" => "label",
                        ...
                        "sub_nilai_items_pph23" => "sub_nilai_items_pph23",
                        //---
                        "produk_rel_harga_dpp" => "produk_rel_harga_dpp",
                        "produk_rel_harga_dpp_pengganti" => "produk_rel_harga_dpp_pengganti",
                        "produk_rel_harga_ppn" => "produk_rel_harga_ppn",
                    ),
                    "paramsQty" => array(
                        "jml" => "jml",
                        "qty" => "qty",
                    ...
                    "targetValueReplacer" => array(
                        "srcMethodeKey" => "ppnMethode__key",
                        "srcMethodeVal" => array(
                            "0" => array(
                                "produk_rel_harga_persediaan" => "produk_rel_harga_after_pph",
                            ),
                            "1" => array(
                                "produk_rel_harga_persediaan" => "produk_rel_harga_dpp",
                            ),
                        )
...
//                        ),
//                    ),
                    "diskon_nilai_total_freeproduk" => "diskon supplier",
                    "nilai_total_diklaim" => "nilai klaim",
                    "sisa_diskon" => "sisa diskon",
                ),
...
//                3 => "",
            ...
            "kolom_registry" => array(
                "produk_rel_harga",// diskon free produk
                "diskon_nilai",// diskon 1,2,3,4,5,dst.
                "diskon_nilai_total",
                "description",
                "description_main_followup",
//                "diskon_1_nilai",
...
//                    "pph23MethodeBarang" => array(
//                        "elementType" => "dataModel",
//                        "inputType" => "radio",
//                        "label" => "PPh Ps23",
//                        "mdlName" => "MdlPph23MethodPotonganModeBarang",
//                        "mdlFilter" => array(),
//                        "key" => "id",
//                        "labelSrc" => "name",
//                        "usedFields" => array(
...
//                        "mdlName" => "MdlPph23MethodPotongan",
            ...
            "pph23MethodeBarang" => array(
                1 => array(
                    ...
                    "defaultDPP_PPh" => array(
                        "elementType" => "dataField",
                        "label" => "DPP PPh Ps 23",
                        "inputType" => "number",
//                        "defaultValue" => "diskon_supplier_nilai",
//                        "defaultValue" => "0",
//                        "defaultValueKey" => "main",
                        "editPoints" => array(1),
                        "noValidate" => true,
                    ),
                ),
