            ...
            "3355" => array(
                "master" => array(
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "1010030030" => "hpp_spec_matelriality_adjustment",// persediaan produk
                            "7010150" => "hpp_spec_matelriality_adjustment",// laba lain-lain
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
                    ...
                    array(
                        ...
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => ".4",// laba rugi lain-lain ppv
                            "extern_nama" => ".konversi produk", // laba rugi lain-lain ppv
                            "jenis" => "jenisTr",
                            "transaksi_no" => "nomer",
                        ),
                        "srcGateName" => "main",
...
//                        "srcRawGateName" => "items",
                    ...
                    array(
                        ...
                        "loop" => array(
                            "1010030030" => "sub_hpp_spec_matelriality_adjustment",//persediaan produk
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => "id",
                            "extern_nama" => "nama",
                            "produk_qty" => ".0",
                            "produk_nilai" => "hpp_spec_matelriality_adjustment",
                            "gudang_id" => "gudangID",
                            "jenis" => "jenisTr",
                            "transaksi_no" => "nomer",
                            "supplierID" => "pihakID",
...
//                            "supplierID" => "pihakID",
            ...
            "3355" => array(
                ...
                "detail" => array(
                    ...
                    array(
                        "comName" => "FifoAverageKoreksiKonversi",
                        "loop" => array(),
                        "static" => array(
                            "jenis" => ".produk",
                            "jml" => "jml",
                            "produk_id" => "id",
                            "nama" => "nama",
                            "hpp" => "hpp_spec_matelriality_adjustment",
                            "jml_nilai" => "sub_hpp_spec_matelriality_adjustment",
                            "hpp_riil" => "hpp_spec_matelriality_adjustment",
                            "jml_nilai_riil" => "sub_hpp_spec_matelriality_adjustment",
                            "ppv_riil" => "ppv",
