...
//                arrPrint($addRowHiddens[$k]);
                ...
                if (isset($shopingcartAddDpp[$k])) {

//                    arrPrint($shopingcartAddDpp[$k]);
                    $colspan_i = sizeof($itemLabels) - 2;
                    foreach ($shopingcartAddDpp[$k] as $ik => $ik_label) {
                        if (isset($main[$ik])) {
                            $colspan_r = "1";
                            echo "<td colspan='$colspan_i' class='text-right bottom_borderless valign-m text-uppercase'>$ik_label</td>";
                            echo "<td colspan='1' class='text-right bottom_borderless valign-m '>" . formatField("total", $main[$ik]) . "</td>";
                        }
                    ...
                    $colspan_r = sizeof($itemLabels);
                }
                echo "<td colspan='" . $colspan_r . "' class='text-right $bottom_borderless valign-m text-uppercase'>$label</td>";
