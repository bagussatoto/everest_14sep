...
//cekKuning($_SESSION[$cCode]['main']['pihakExternName']);
        $data = array(
            "mode" => "createForm",
            ...
            "selectorCaller3" => isset($this->configUi[$jenisTr]["selectorCaller3"]) ? base_url() . $this->modul . DIRECTORY_SEPARATOR . $this->configUi[$jenisTr]["selectorCaller3"] . "/$jenisTr/" . $this->configUi[$jenisTr]["selectorModel3"] : "",
            "selectorCaller4" => isset($this->configUi[$jenisTr]["selectorCaller4"]) ? base_url() . $this->modul . DIRECTORY_SEPARATOR . $this->configUi[$jenisTr]["selectorCaller4"] . "/$jenisTr/" . $this->configUi[$jenisTr]["selectorModel4"] : "",
            ...
            "pihakCaller4" => isset($this->configUi[$jenisTr]["pihakCaller4"]) ? base_url() . $this->modul . DIRECTORY_SEPARATOR . $this->configUi[$jenisTr]["pihakCaller4"] . "/$jenisTr/" . $this->configUi[$jenisTr]["pihakModel4"] : "",
            "pihakExternCaller" => isset($this->configUi[$jenisTr]["pihakExternCaller"]) ? base_url() . $this->modul . DIRECTORY_SEPARATOR . $this->modul . DIRECTORY_SEPARATOR . $this->configUi[$jenisTr]["pihakExternCaller"] . "/$jenisTr/" . $this->configUi[$jenisTr]["pihakModelExtern"] : "",
            ...
            //----------------------------------
            "pihakExternCallerDelete" => base_url() . $this->modul . DIRECTORY_SEPARATOR . "_processPihak/removeExtern/$jenisTr",
//            "pihakExternLabel" => isset($this->configUi[$jenisTr]["pihakExternLabel"]) ? $this->configUi[$jenisTr]["pihakExternLabel"] : "",
            //----------------------------------
            ...
            //"pihakMainLabel" => isset($_SESSION[$cCode]['main']["pihakMainName"]) ? $_SESSION[$cCode]['main']["pihakMainName"] : isset($this->configUi[$jenisTr]["pihakMainLabel"]) ? $this->configUi[$jenisTr]["pihakMainLabel"] : "",
            ...
            "pihakExternLabel" => isset($_SESSION[$cCode]['main']['pihakExternName']) ? $_SESSION[$cCode]['main']['pihakExternName'] : isset($this->configUi[$jenisTr]["pihakExternLabel"]) ? $this->configUi[$jenisTr]["pihakExternLabel"] : "",
//            "pihakExternLabel" => isset($_SESSION[$cCode]['main']['pihakExternLabel']) ? $_SESSION[$cCode]['main']['pihakExternName'] . "(" . $this->configUi[$jenisTr]["pihakExternLabel"] . ")" : isset($this->configUi[$jenisTr]["pihakExternLabel"]) ? $this->configUi[$jenisTr]["pihakExternLabel"] : "",
    ...
    public function preview()
    {
        ...
        $shopingcartAddDpp = isset($this->configUi[$this->jenisTr]['shopingcartAddDpp'][$stepNumber]) ? $this->configUi[$this->jenisTr]['shopingcartAddDpp'][$stepNumber] : array();
        //--------------------------
...
//            $shoppingCartAdvanceAmountValue = isset($this->configUi[$this->jenisTr]['shoppingCartAdvanceAmountValue']) ? $this->configUi[$this->jenisTr]['shoppingCartAdvanceAmountValue'] : array();
            ...
            $shoppingCartAdvanceItemsSelector = isset($this->configUi[$this->jenisTr]['shoppingCartAdvanceItemsSelector']) ? $this->configUi[$this->jenisTr]['shoppingCartAdvanceItemsSelector'] : array();
            $shoppingCartAdvanceItemsRemove = isset($this->configUi[$this->jenisTr]['shoppingCartAdvanceItemsRemove']) ? $this->configUi[$this->jenisTr]['shoppingCartAdvanceItemsRemove'] : array();
            $shoppingCartAdvanceItemsAdd = isset($this->configUi[$this->jenisTr]['shoppingCartAdvanceItemsAdd']) ? $this->configUi[$this->jenisTr]['shoppingCartAdvanceItemsAdd'] : array();
...
//                    $advanceAmountItemsLabel = isset($shoppingCartAdvanceAmountValue[$key_result][$stepNumber]) ? $shoppingCartAdvanceAmountValue[$key_result][$stepNumber] : array();
        ...
        $data = array(
            ...
            "shopingcartAddDpp" => $shopingcartAddDpp,
...
//            validateJurnal($insertID, $componentConfig);
            ...
            if ($pakai_ini == 1) {
                ...
                $connectValidate = isset($this->configUi[$this->jenisTr]['connectoValidate'][1]) ? $this->configUi[$this->jenisTr]['connectoValidate'][1] : array();

                $configUiMasterModulOrigJenis = loadConfigModulJenis_he_misc($this->jenisTr, "coTransaksiUi");
                $configCoreMasterModulOrigJenis = loadConfigModulJenis_he_misc($this->jenisTr, "coTransaksiCore");
                $configLayoutMasterModulOrigJenis = loadConfigModulJenis_he_misc($this->jenisTr, "coTransaksiLayout");
                ...
                $validateValueConnector = isset($configUiMasterModulJenis['connectoValidate'][1]) ? $configUiMasterModulJenis['connectoValidate'][1] : array();
                $mongoListConnect = array();
                $mongRegIDConnect = array();

                if (isset($_SESSION[$cCode]["main"][$connectValidate]) && $_SESSION[$cCode]["main"][$connectValidate] > 100) {
                    if (strlen($connector) > 0) {
                        ...
                        if (sizeof($steps) == 1) {
                            ...
                            if (sizeof($connectoSwitcherGate) > 0) {
                                ...
                                $sessionGateSource = isset($_SESSION[$cCode][$gateSource]) ? $_SESSION[$cCode][$gateSource] : array();
                                $sessionGateTarget = isset($_SESSION[$cCode][$gateTarget]) ? $_SESSION[$cCode][$gateTarget] : array();
                                $_SESSION[$cCode][$gateSource] = $sessionGateTarget;
                                $_SESSION[$cCode][$gateTarget] = $sessionGateSource;
                            }
...
//arrPrintOrange($_SESSION[$cCode]['tableIn_master']);
//arrPrintHitam($_SESSION[$cCode]['items']);
                            $baseRegistries = array(
                                'main' => isset($_SESSION[$cCode]['main']) ? $_SESSION[$cCode]['main'] : array(),
                                'items' => isset($_SESSION[$cCode]['items']) ? $_SESSION[$cCode]['items'] : array(),
                                'items2' => isset($_SESSION[$cCode]['items2']) ? $_SESSION[$cCode]['items2'] : array(),
