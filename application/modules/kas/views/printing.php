        ...
        if (isset($items5) && sizeof($items5) > 0) {
            ...
            if (isset($items5) && is_array($items5)) {
                foreach ($items5 as $row) {
                    $total_modal_bom += (float)$row['harga'];
                }
            }
            $markup_factor = ($total_modal_bom > 0) ? ($project__harga_f / $total_modal_bom) : 1;
            ...
            foreach ($items5 as $iSpec) {
                ...
                $harga_proproporsional = (isset($iSpec['harga']) ? (float)$iSpec['harga'] : 0) * $rasio_markup;
                ...
                if ($opsi_cetak == 3 || $opsi_cetak == 4) {
                    ...
                    if (isset($iSpec['bahan_baku']['biaya'])) {
                        foreach ($iSpec['bahan_baku']['biaya'] as $prdData) {
                            ...
                            $saldo_rasio = (float)$prdData['saldo'] * $rasio_markup;
                            $satuan = isset($prdData['satuan']) && !empty($prdData['satuan']) ? $prdData['satuan'] : 'Unit';
            ...
            if ($opsi_cetak == 3) {
                ...
                foreach ($items5 as $iSpec) {
                    $no++;
                    $total_baris_um = (isset($iSpec['harga']) ? (float)$iSpec['harga'] : 0) * $rasio_markup;
