...
//        ),
        ...
        "shoppingCartEditableValidatorLabel" => array(
            1 => array(
                "1010050010" => "<b>[PERINGATAN] NOMINAL MELEBIHI SISA SALDO TITIPAN</b><br><br>Nominal ganti/pindah relasi yang Anda masukkan melebihi sisa saldo titipan.<br><br>&bull; <b>Nominal Pengajuan</b>: Rp {entry_nilai}<br>&bull; <b>Sisa Saldo Tersedia</b>: Rp {source_nilai}<br><br><b>Solusi</b>: Silakan sesuaikan nominal pengajuan maksimal senilai Rp {source_nilai} atau pilih PO lain yang memiliki saldo memadai.",
            ),
        ),
    ),
...
//                "referensi_so__project_nama" => "Project",
                "referensi_so_project__nama" => "Project",
                "oleh_nama" => "person",
...
//                            "seller_nama" => "salesman",
                            ...
                            "quot_appr_dtime" => "date project",
                            "nama" => "project",
                            "harga" => "nilai project (Excl PPN)",
                            "ppn" => "PPN project (11%)",
                            "harga_nppn" => "nilai project (Incl PPN)",
                            "uangmuka_persen" => "uang muka (%)",
                            "uangmuka_rp" => "uang muka (Rp)",
                            "retensi_persen" => "nilai retensi (%)",
                            "retensi_rp" => "nilai retensi (Rp)",
