...
//                $strOnprog .= "<div class='table-responsive'>";
                $strOnprog .= "<table id='arrayOnProgress' class='table stripe compact nowarp order-column table-condensed table-bordered no-padding' style='border:solid red 0px;'>";
                $strOnprog .= "<thead>";
...
//cekHere($stepper);
    ...
    $(document).ready( function () {
        if( $('table#arrayOnProgressHistory') ){
            ...
            if ($('table#arrayOnProgressHistory').length) {
                ...
                new $.fn.dataTable.FixedHeader( arrayOnProgressHistory );
            }
            ...
            if ($kelebihanBayarMethod == true) {
                ...
                $paymentRows = array(
                    " " => "<label>
                            ...
                            \"> i confirm that the numbers above are correct ($jenisTr #1)</label>",
                ...
                $paymentRows = array(
                    " " => "<label>
                            ...
                            //}
                            //}
                            \"> i confirm that the numbers above are correct ($jenisTr #2)</label>",
...
//                                            + \"<div class='text-right'>\"+addCommas(total5)+\"</div>\"
    ...
    case "viewResume":
        ...
        // arrPrint($detil_item_rslt);
        // tambahan detail isi nota top
        // arrPrint($detil_item_rslt_label);
...
//            $strOnprogFooter = "<a class='btn btn-default' href='" . base_url() . $this->uri->segment(1) . "/viewIncomplete/" . $jenisTr . "'><span class='glyphicon glyphicon-time'></span> complete list ...</a>";
        ...
        $paymentRows = array(
            " " => "<label>
                            ...
                            //}
                            //}
                            \"> i confirm that the numbers above are correct ($jenisTr #3)</label>",
