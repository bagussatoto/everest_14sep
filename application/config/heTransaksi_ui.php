...
//                "allowScaner" => true,
    ...
    "4892" => array(
        ...
        "deskripsi" => "Entry faktur dari supplier",
        "paymentConfig" => true,
        "place" => "center",
        "steps" => array(
            //            1 => array(
...
//                "userGroup" => "o_finance",
    ...
    "6677" => array(
        ...
        // langkah selanjutnya: otorisasi ke kode 16677
        "connectTo" => "16677",
        // langkah selanjutnya: pelunasan tagihan pajak ke kode 7468
        "connectToPayment" => array(
            "modul" => "kas",
            "connectTo" => "7468",
        ),
        // langkah selanjutnya: penyerahan barang hadiah ke kode 66771, namun wajib menunggu tagihan pajak lunas kode 7468
        "connectToWarehouse" => array(
            "modul" => "penjualan",
            "connectTo" => "66771",
        ),
...
//                "stateCaption" => "prepare by",
    ...
    "16677" => array(
        ...
        "steps" => array(
            1 => array(
                "label" => "persiapan cashback penjualan (biaya)",
                "actionLabel" => "simpan",
                "source" => "",
                "target" => "16677r",
                "userGroup" => "sys",
    ...
    "66772" => array(
        "modul" => "biaya",
        "icon" => "fa fa-money",
        "label" => "rebate penjualan (barang)",
        "place" => "branch",
        "steps" => array(
            1 => array(
                "label" => "request rebate penjualan (barang)",
                "actionLabel" => "simpan",
                "source" => "",
                "target" => "66772",
                "userGroup" => "o_kasir",
        ...
        // langkah selanjutnya: penyerahan barang hadiah ke kode 66773
        "connectToWarehouse" => array(
            "modul" => "penjualan",
            "connectTo" => "66773",
        ),
...
//    "99999" => array(
//        //untuk tutup buku  tahunan dan open baru didatabase terpisah
//        "modul" => "openbalance",
//        "icon" => "fa fa-money",
//        "label" => "open balance",
//        "place" => "center",
...
//            ),
//            2 => array(
//                "label" => "authorization opening balance",
//                "actionLabel" => "approve request",
//                "source" => "99999r",
//                "target" => "99999",
//                "userGroup" => "c_finance",
...
//        "modul" => "asetmanagement",
        "icon" => "fa fa-money",
        "label" => "rugilaba pusat",
        "place" => "center",
        "steps" => array(
            1 => array(
                "label" => "rugilaba pusat",
                "actionLabel" => "rugilaba pusat",
                "source" => "",
                "target" => "1000",
                "userGroup" => "sys",
                "stateLabel" => "rugilaba pusat",
                "stateColor" => "#dd3300",
                "stateCaption" => "prepare by",
            ),
//            2 => array(
...
//        "modul" => "asetmanagement",
        "icon" => "fa fa-money",
        "label" => "rugilaba cabang",
        "place" => "center",
        "steps" => array(
            1 => array(
                "label" => "rugilaba cabang",
                "actionLabel" => "rugilaba cabang",
                "source" => "",
                "target" => "1001",
                "userGroup" => "sys",
                "stateLabel" => "rugilaba cabang",
                "stateColor" => "#dd3300",
                "stateCaption" => "prepare by",
            ),
//            2 => array(
...
//            ),
    ...
    // endregion saham dan pihak lain
